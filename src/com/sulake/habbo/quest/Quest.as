package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1528:Date;
      
      private var _localizationCode:String;
      
      private var var_185:Boolean = false;
      
      private var var_2122:uint = 2;
      
      private var var_2121:uint = 0;
      
      private var var_801:IWindow;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1461 = param1.roomItemTypeName;
         this.var_1462 = param1.rewardCurrencyAmount;
         this.var_1528 = new Date();
         this.var_1528.setTime(param1.endDateTimeStamp);
      ...
      private function createView() : void
      {
         switch(this._status)
         {
            case QuestStatusEnum.const_41:
               this._view = this.var_69.controller.questEngine.getXmlWindow("QuestEntityAccepted") as IWindowContainer;
               break;
            case QuestStatusEnum.const_517:
               this._view = this.var_69.controller.questEngine.getXmlWindow("QuestEntityAvailable") as IWindowContainer;
               break;
            case QuestStatusEnum.const_186:
               this._view = this.var_69.controller.questEngine.getXmlWindow("QuestEntityExpired") as IWindowContainer;
               break;
            case QuestStatusEnum.const_568:
               this._view = this.var_69.controller.questEngine.getXmlWindow("QuestEntityCompleted") as IWindowContainer;
               break;
            case QuestStatusEnum.const_167:
               this._view = this.var_69.controller.questEngine.getXmlWindow("QuestEntityPreview") as IWindowContainer;
               break;
            default:
               this._view = this.var_69.controller.questEngine.getXmlWindow("QuestEntityExpired") as IWindowContainer;
         }
      ...
      private function updateView() : void
      {
         ...
         {
            case QuestStatusEnum.const_41:
               _loc2_ = ["icon",this.var_69.id,"active"].join("_");
               this.var_69.controller.questEngine.setImageFromAsset(_loc1_,_loc2_,this.onPreviewImageReady);
               break;
            case QuestStatusEnum.const_517:
               break;
            case QuestStatusEnum.const_186:
               break;
            case QuestStatusEnum.const_568:
               this.var_69.controller.questEngine.setImageFromAsset(_loc1_,"icon_complete",this.onPreviewImageReady);
         }
         var _loc3_:String = ["quest",this.var_69.id,this._localizationCode].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         {
            this.var_69.activateListItem(this);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_185)
            {
               this.var_801.style = this.var_2121;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_185)
            {
               this.var_801.style = this.var_2122;
            }
         }
      }
