package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_433:Quest;
      
      private var var_265:QuestView;
      
      private var _window:IFrameWindow;
      
      private var var_968:IWindowContainer;
      
      private var var_1218:IWindowContainer;
      
      private var var_264:IItemListWindow;
      
      private var var_652:Array;
      
      private var var_700:Boolean = false;
      
      private var var_967:IWindowContainer;
      
      private var var_167:QuestHelp;
      ...
      public function QuestCampaign(param1:QuestController, param2:String, param3:int)
      {
         ...
         this.var_167 = new QuestHelp(this);
      }
      ...
      private function reset() : void
      {
         ...
         if(this.var_300)
         {
            ...
            {
               this.var_264.removeListItem(_loc1_.view);
               _loc1_.dispose();
            }
            this.var_300 = null;
            this.var_264.destroyListItems();
            this.var_264.removeListItems();
         }
         this.var_433 = null;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_968 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1218 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_264 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.id + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1218.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1218.findChildByName("currency.amount").caption = "${quest_" + this.id + ".currency}";
         ...
         this.var_967 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_967)
         {
            this.var_967.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_967.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_967.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_433)
         {
            this.var_433.selected = false;
         }
         if(this.var_167)
         {
            this.var_968.addChild(this.var_167.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1579);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1218.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_264.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_41 || _loc4_.status == QuestStatusEnum.const_517))
            {
               _loc3_ = _loc4_;
            }
         }
         if(_loc3_)
         {
            ...
            if(this.var_264.maxScrollV > 0)
            {
               this.var_264.scrollV = _loc3_.view.y / this.var_264.maxScrollV;
            }
         }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_433 = param1;
         this.var_433.selected = true;
         this.showQuestData(this.var_433);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_265 = new QuestView(this,param1);
         this.var_968.addChild(this.var_265.view);
         this.var_265.init();
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_652.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         for each(_loc3_ in this.var_652)
         {
            if(_loc3_ == param1)
            {
               _loc2_ = _loc3_;
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_652.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_652.splice(_loc4_,1);
            }
         }
      }
      ...
      private function modifyQuestData(param1:QuestMessageData) : void
      {
         ...
         if(_loc2_)
         {
            ...
            _loc6_ = this.var_264.getListItemIndex(_loc2_.view);
            this.var_264.removeListItem(_loc2_.view);
            if(_loc6_ > -1)
            {
               this.var_264.addListItemAt(_loc5_.view,_loc6_);
            }
            else
            {
               this.var_264.addListItem(_loc5_.view);
            }
            if(this.var_433 == _loc2_)
            {
