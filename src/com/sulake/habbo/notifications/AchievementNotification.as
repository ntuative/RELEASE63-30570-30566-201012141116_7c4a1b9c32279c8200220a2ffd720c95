package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1560:String = "badge_bg_001_png";
      
      private const const_1830:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1604 = param6;
         this._localizations = param10;
         this._assets = param8;
         this.var_355 = param13;
         ...
         this._window.center();
         this.var_2262 = this._localizations.getBadgeName(this.var_269);
         this.var_2266 = this._localizations.getBadgeDesc(this.var_269);
         this.var_2263 = this._localizations.getAchievementNameForFacebook(this.var_269,this.var_355.userName,this.var_355.realName,this.var_1267);
         this.var_2267 = this._localizations.getAchievementDescForFacebook(this.var_269,this.var_355.userName,this.var_355.realName,this.var_1267);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2265 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this._localizations.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1816.toString());
         this._localizations.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1268.toString());
         this._localizations.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1268.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1604;
         var _loc17_:String = this.var_1604 == 0 ? "pixels" : "activitypoints";
         this._localizations.registerParameter(_loc16_,_loc17_,"" + this.var_1900);
         _loc15_.caption = this._localizations.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1560);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1830) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1268 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_269,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_269,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_269,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this._localizations.registerParameter(param1,"badge_name",this.var_2262);
         this._localizations.registerParameter(param1,"badge_desc",this.var_2266);
         this._localizations.registerParameter(param1,"badge_name_fb",this.var_2263);
         this._localizations.registerParameter(param1,"badge_desc_fb",this.var_2267);
         this._localizations.registerParameter(param1,"level",this.var_1267.toString());
         this._localizations.registerParameter(param1,"name",this.var_355.userName);
         return this._localizations.registerParameter(param1,"realname",this.var_355.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_355.events.removeEventListener(BadgeImageReadyEvent.const_125,this.onBadgeImageReady);
            this.var_355 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_269)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1560);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_269,this._feedTitleFb,this.var_2265,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2264));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_269,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_269,"client.skip_post"));
               this.dispose();
               return;
         }
      }
