package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_795:int = 70;
      
      public static const const_466:int = 4;
      ...
      private var var_193:HabboNotificationItem;
      
      private var var_1468:Boolean = false;
      
      private var var_1961:Map;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1466 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1466 = 15;
         }
         this.var_1467 = this._window.height;
         this.var_642 = 4;
         this.var_641 = 0;
         this._state = name_1;
      ...
      {
         if(param1.badgeId != this.var_193.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_418:
               this.var_950 += param1;
               _loc2_ = Number(this.var_950) / Number(this.var_352["time_fade_in"]);
               if(this.var_950 > int(this.var_352["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_828:
               ...
               if(this.var_1197 > int(this.var_352["time_display"]) && !this.var_1468)
               {
                  this.startFadeOut();
               }
               break;
            case const_827:
               this.var_949 += param1;
               _loc3_ = 1 - Number(this.var_949) / Number(this.var_352["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_949 > int(this.var_352["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1466;
         if(this._window.height < this.var_1467)
         {
            this._window.height = this.var_1467;
         }
      }
      ...
      {
         this.var_949 = 0;
         this._state = const_827;
      }
      
      private function startDisplay() : void
      {
         this.var_1197 = 0;
         this._state = const_828;
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         if(this.var_352["position_horizontal_follow_toolbar"] == "true" && (this._toolbar.orientation != "TOP" && this._toolbar.orientation != "BOTTOM"))
         {
            ...
            {
               this._window.x = _loc5_ + const_466;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_466;
            }
         }
         ...
         if(this.var_352["position_vertical_follow_toolbar"] == "true" && (this._toolbar.orientation != "RIGHT" && this._toolbar.orientation != "LEFT"))
         {
            ...
            {
               this._window.y = _loc3_ + this.var_642;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_642;
            }
         }
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_641;
      }
   }
}
