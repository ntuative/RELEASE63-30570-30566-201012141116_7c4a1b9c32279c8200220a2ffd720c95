package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      private var var_2645:Number;
      
      private var var_2646:Number;
      
      private var _state:String;
      
      private var var_1664:String;
      
      private var var_898:BitmapData;
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1366 = param1.loop;
         if(param1.background != null)
         {
            this.var_898 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         if(_loc9_.length() > 0)
         {
            ...
            while(_loc10_ < _loc9_.length())
            {
               ...
               if(_loc8_ != null)
               {
                  this.var_900.push(_loc11_);
                  this.var_901.push(_loc8_);
               }
               _loc10_++;
            }
         }
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_900.push(new XML());
               this.var_901.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_901[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1366 == true || this.var_899 == 0)
         {
            if(this.var_900.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_900.length)
               {
                  this._frame = 0;
                  ++this.var_899;
               }
      ...
      {
         return this.var_900.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1366 == false && this.var_899 == 1 && this.var_1664 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_901.length)
         {
            _loc2_ = this.var_901[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_898.width),Math.max(param2.height,this.var_898.height));
            _loc3_.copyPixels(this.var_898,this.var_898.rect,new Point(0,0));
