package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_195:Boolean = true;
      
      private static const const_1198:Number = 25;
      
      private static const const_1250:Number = 90;
      
      private static const const_854:int = 50;
      
      private static const const_1197:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1281:ToolbarView;
      
      private var var_684:Timer;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_550 = new Object();
         this.var_549 = new Array();
         this.var_551 = new Array();
         super();
         this._windowManager = param1;
         this.var_1281 = param2;
         this.var_684 = new Timer(const_1198);
         this.var_684.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_310[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_854 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_854 || param1.desktop.height - param1.y < const_1197;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1281.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_310.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1281.getIconLoc(param1.iconId);
      ...
      {
         return this.var_549[this.var_551.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_551[this.var_549.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_551.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_551.splice(_loc3_,1);
            this.var_549.splice(_loc3_,1);
         }
         this.var_549.push(param1.name);
         this.var_551.push(param2);
         param1.addEventListener(WindowEvent.const_342,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_248,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_550[_loc3_] == null)
            {
               this.var_550[_loc3_] = new Array();
            }
            if(this.var_550[_loc3_].indexOf(param1) < 0)
            {
               this.var_550[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_310.indexOf(param1) > -1)
         {
            if(const_195)
            {
            ...
            else
            {
               ...
               this.var_310.splice(this.var_310.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_549.length)
         {
            if(this.var_549[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_551[_loc2_];
               if(this.var_550[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_550[_loc3_].length)
                  {
                     this.repositionWindow(this.var_550[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_310.length)
         {
            _loc2_ = this._itemList[this.var_310[_loc7_]];
            if(_loc2_.active)
            {
