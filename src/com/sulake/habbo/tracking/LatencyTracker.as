package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1767 = int(this._configuration.getKey("latencytest.interval"));
         this.var_1766 = int(this._configuration.getKey("latencytest.report.index"));
         this.var_2479 = int(this._configuration.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1768 > this.var_1767)
         {
            this.testLatency();
         }
      }
      ...
      private function testLatency() : void
      {
         ...
         this.var_592.add(this.var_1374,this.var_1768);
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_592 == null || this.var_207 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = this.var_592.getValue(_loc2_.requestId);
         this.var_592.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         this.var_207.push(_loc4_);
         if(this.var_207.length == this.var_1766 && this.var_1766 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1765) > this.var_2479 || this.var_1765 == 0)
            {
               this.var_1765 = _loc9_;
