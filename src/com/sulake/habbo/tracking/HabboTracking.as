package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_860:uint = 11;
      ...
      private var var_1067:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_167:IHabboHelp;
      ...
      private var var_563:FramerateTracker = null;
      
      private var var_233:LatencyTracker = null;
      
      private var var_562:LagWarningLogger = null;
      
      private var var_561:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_234 = new PerformanceTracker();
         this.var_563 = new FramerateTracker();
         this.var_233 = new LatencyTracker();
         this.var_562 = new LagWarningLogger();
         this.var_561 = new ToolbarClickTracker(this);
         this.var_1307 = new Array(const_860);
         var _loc4_:int = 0;
         while(_loc4_ < const_860)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1323,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1343,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_678,String(false));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1067)
            {
               this.var_1067.release(new IIDHabboWindowManager());
               this.var_1067 = null;
            }
            if(this.var_278)
            {
            ...
            if(this.var_179)
            {
               ...
               {
                  Component(this.var_179).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_179).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_179).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_179).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_179).events.removeEventListener(HabboFriendListTrackingEvent.const_373,this.onFriendlistTrackingEvent);
               }
               this.var_179.release(new IIDHabboFriendList());
               this.var_179 = null;
            }
            if(this.var_167)
            {
               if(!this.var_167.disposed)
               {
                  this.var_167.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_167.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_167.release(new IIDHabboHelp());
               this.var_167 = null;
            }
            if(this._toolbar)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._configuration)
         {
            if(this.var_233 != null)
            {
               this.var_233.configuration = this._configuration;
            }
            if(this.var_234 != null)
            {
               this.var_234.configuration = this._configuration;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1492);
            if(this._configuration)
            {
               if(this.var_562 != null)
               {
                  this.var_562.configure(this._configuration);
               }
               if(this.var_563 != null)
               {
                  this.var_563.configure(this._configuration);
               }
               if(this.var_561 != null)
               {
                  this.var_561.configure(this._configuration);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_147);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_758,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_203,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_189,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_184,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_211,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_212,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_564,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_65,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_405,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_234 != null)
            {
               this.var_234.connection = param1;
            }
            if(this.var_233 != null)
            {
               this.var_233.communication = this._communication;
               this.var_233.connection = param1;
            }
            if(this.var_562 != null)
            {
               this.var_562.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_564)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1408);
         }
         else if(param1.type == HabboHotelViewEvent.const_405)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1278);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1394);
               break;
            case HabboCommunicationEvent.const_758:
               this.trackLoginStep(HabboLoginTrackingStep.const_1333,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_203:
               this.trackLoginStep(HabboLoginTrackingStep.const_203);
               break;
            case HabboCommunicationEvent.const_184:
               this.trackLoginStep(HabboLoginTrackingStep.const_184);
               break;
            case HabboCommunicationEvent.const_189:
               this.setErrorContextFlag(2,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_189);
               break;
            case HabboCommunicationEvent.const_211:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_211);
               if(this.var_233 != null)
               {
                  this.var_233.init();
               }
               break;
            case HabboCommunicationEvent.const_212:
               this.trackLoginStep(HabboLoginTrackingStep.const_212);
         }
         if(this._communication)
         {
      ...
      {
         this.var_1067 = IHabboWindowManager(param2);
         if(this.var_1067)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this._configuration)
            {
               if(this._configuration.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(this.var_234 != null)
                  {
                     _loc4_["null"] = this.var_234.flashVersion;
                     _loc4_["null"] = this.var_234.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_962);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_962,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_179 = param2 as IHabboFriendList;
         Component(this.var_179).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_179).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_179).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_179).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_179).events.addEventListener(HabboFriendListTrackingEvent.const_373,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_373:
      ...
      {
         this.var_167 = param2 as IHabboHelp;
         this.var_167.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_167.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2359)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1314);
            this.var_2359 = true;
         }
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_678,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_267,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_278 = param2 as IAdManager;
         this.var_278.events.addEventListener(AdEvent.const_493,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_561)
         {
            this.var_561.track(param1.iconName);
         }
      }
      ...
      {
         this.var_562.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_462 > -1 && _loc2_ < this.var_462)
         {
            ++this.var_1669;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1669);
         }
         if(this.var_462 > -1 && _loc2_ - this.var_462 > 15000)
         {
            ++this.var_1668;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1668);
         }
         this.var_462 = _loc2_;
         if(this.var_234 != null)
         {
            this.var_234.update(param1,this.var_462);
         }
         if(this.var_233 != null)
         {
            this.var_233.update(param1,this.var_462);
         }
         if(this.var_563 != null)
         {
            this.var_563.trackUpdate(param1,this,this.var_462);
         }
         if(this.var_562 != null)
         {
            this.var_562.update(this.var_462);
         }
      }
   }
}
