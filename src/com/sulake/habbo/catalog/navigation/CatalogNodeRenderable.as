package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1254:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1402:XML;
      
      private static var var_1403:XML;
       
      
      private var var_1831:Number = 4.294967295E9;
      ...
      public function addToList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            ...
            param1.addListItem(this.var_51);
         }
      }
      ...
      public function removeFromList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            param1.removeListItem(this.var_51);
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1831 == 4294967295)
            {
               this.var_1831 = _loc1_.color;
            }
            _loc1_.color = const_1254;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1464;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1500;
            }
         }
      }
      ...
      private function showChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            ...
            {
               (_loc1_ as CatalogNodeRenderable).addToList(this.var_51);
            }
         }
         if(this.var_51 != null)
         {
            this.var_51.visible = true;
            this.var_51.height = this.var_51.numListItems * 21;
         }
      }
      ...
      private function removeChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            if(_loc1_.isNavigateable)
            {
               (_loc1_ as CatalogNodeRenderable).removeFromList(this.var_51);
            }
         }
         if(this.var_51 != null)
         {
            this.var_51.height = 0;
      ...
      {
         this.var_51 = navigator.catalog.windowManager.buildFromXML(var_1403) as IItemListWindow;
         if(this.var_51 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1402) as IWindowContainer;
         }
         else
         {
