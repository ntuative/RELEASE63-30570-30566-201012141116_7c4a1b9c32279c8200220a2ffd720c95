package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_84:IPurchasableOffer;
      ...
      private var var_337:int = -1;
      
      private const const_1851:int = 10;
      ...
      private const const_1573:uint = 4.293848814E9;
      
      private const const_1572:uint = 4.294967295E9;
      
      private const const_1852:uint = 4.291613146E9;
      ...
      {
         if(this.var_84 == null || this.var_84.offerId != param1.offerId)
         {
            return;
         }
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = this._catalog.getProductData(this.var_84.localizationId);
         ...
         if(_loc2_ != null)
         {
            _loc4_ = this.var_84.page.viewer.roomEngine;
            _loc7_ = 0;
            _loc8_ = "";
            _loc9_ = "";
            if(this.var_84 is Offer)
            {
               _loc10_ = this.var_84.productContainer.firstProduct;
               _loc9_ = _loc10_.productType;
               _loc7_ = _loc10_.productClassId;
               _loc8_ = _loc10_.extraParam;
            }
            else if(this.var_84 is ClubBuyOfferData)
            {
               _loc9_ = "null";
            }
            switch(_loc9_)
      ...
      private function updateLocalizations() : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:IProductData = this._catalog.getProductData(this.var_84.localizationId);
         ...
         var _loc8_:String = this.var_84.activityPointType == Purse.const_398 ? "pixels" : "activitypoints";
         switch(this.var_84.priceType)
         {
            case Offer.const_537:
               ...
               this._localization.registerParameter(_loc6_,"credits",this.var_84.priceInCredits.toString());
               _loc3_ = _loc5_.value;
               this._localization.registerParameter(_loc6_,"credits",_loc7_);
               _loc4_ = _loc5_.value;
               break;
            case Offer.const_598:
               _loc6_ = "catalog.purchase.confirmation.dialog.price.credits+activitypoints." + this.var_84.activityPointType;
               _loc5_ = this._localization.getLocalization(_loc6_);
               this._localization.registerParameter(_loc6_,"credits",this.var_84.priceInCredits.toString());
               this._localization.registerParameter(_loc6_,_loc8_,this.var_84.priceInActivityPoints.toString());
               _loc3_ = _loc5_.value;
               this._localization.registerParameter(_loc6_,"credits",_loc7_);
               this._localization.registerParameter(_loc6_,_loc8_,this._catalog.getPurse().getActivityPointsForType(this.var_84.activityPointType).toString());
               _loc4_ = _loc5_.value;
               break;
            case Offer.const_605:
               _loc6_ = "catalog.purchase.confirmation.dialog.price.activitypoints." + this.var_84.activityPointType;
               _loc5_ = this._localization.getLocalization(_loc6_);
               this._localization.registerParameter(_loc6_,_loc8_,this.var_84.priceInActivityPoints.toString());
               _loc3_ = _loc5_.value;
               this._localization.registerParameter(_loc6_,_loc8_,this._catalog.getPurse().getActivityPointsForType(this.var_84.activityPointType).toString());
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1798 = _loc1_.stuffTypes;
            this.var_740 = _loc1_.boxTypes;
            this.var_741 = _loc1_.ribbonTypes;
            this.var_1141 = this.var_1798[0];
            this.var_335 = this.var_740[0];
            this.var_336 = this.var_741[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_336 < 0)
         {
            this.var_336 = this.var_741.length - 1;
         }
         if(this.var_336 > this.var_741.length - 1)
         {
            this.var_336 = 0;
         }
         if(this.var_335 < 0)
         {
            this.var_335 = this.var_740.length - 1;
         }
         if(this.var_335 > this.var_740.length - 1)
         {
            this.var_335 = 0;
         }
         var _loc1_:int = this.var_740[this.var_335] * 1000 + this.var_741[this.var_336];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_84.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1141,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1394 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1798;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_83);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1141);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_740[this.var_335]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_741[this.var_336]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_84,this.var_1395,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_84.offerId,this.var_1395);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_104:
               ...
               if(this.var_2562 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_189)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1851)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2562 = _loc3_.text;
               break;
            case WindowMouseEvent.const_38:
               ...
               break;
            case WindowKeyboardEvent.const_751:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_337 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_337 + 1);
                     break;
      ...
      {
         if(this.var_248 == null || !this.var_248.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_248.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_337) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_248 == null)
         {
            this.var_248 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_608 == null)
         {
            this.var_608 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_608.procedure = this.suggestionsEventHandler;
         }
         if(this.var_248 == null || this.var_608 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_248.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_608.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_337) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_337);
         }
         this.var_337 = param1;
         if(this.var_337 < 0)
         {
            this.var_337 = _loc2_.numListItems - 1;
         }
         if(this.var_337 >= _loc2_.numListItems)
         {
            this.var_337 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_337) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1852;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1573) : uint(this.const_1572);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_248.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1141;
               }
            }
            _loc4_++;
         }
