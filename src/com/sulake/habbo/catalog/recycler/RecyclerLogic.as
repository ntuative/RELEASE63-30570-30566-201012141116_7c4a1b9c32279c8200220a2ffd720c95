package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_859:int = 0;
      
      private static const const_390:int = 1;
      
      private static const const_858:int = 2;
      ...
      {
         return this.var_559 != const_859;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1657 != RecyclerStatusMessageEvent.const_1070;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_559 == const_390;
      }
      ...
      {
         this.var_559 = const_858;
         this.var_106 = new Array(const_168);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1657)
         {
            case RecyclerStatusMessageEvent.const_1349:
               this.var_559 = const_390;
               if(this._view == null)
               {
                  return;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1070:
               if(this._view == null)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1396:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1032:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1297:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_106.length > 0)
         {
            oldObjectData = this.var_106[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_168)
            {
               oldObjectData = this.var_106[newSlotId];
         ...
         this.var_106[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_106[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_106[param1].id))
         {
            return;
         }
         this.var_106[param1] = null;
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_106.length < const_168)
         {
            return false;
         }
         var _loc1_:int = 0;
         while(_loc1_ < this.var_106.length)
         {
            if(this.var_106[_loc1_] == null)
            {
               return false;
            }
            _loc1_++;
