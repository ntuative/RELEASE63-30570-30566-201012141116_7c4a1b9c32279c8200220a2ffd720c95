package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_291:CatalogViewer;
      
      private var var_290:ICatalogNavigator;
      ...
      private var var_188:PurchaseConfirmationDialog;
      ...
      private var var_1896:Boolean = true;
      
      private var var_1420:Boolean = false;
      
      private var var_1897:GiftWrappingConfiguration;
      
      private var var_939:ClubGiftController;
      
      private var var_417:ClubBuyController;
      
      public function HabboCatalog(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_101 = new Purse();
      ...
      {
         var _loc4_:* = null;
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_101.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_101.getActivityPointsForType(param1.activityPointType))
         {
         ...
         if(param1 is Offer)
         {
            if(this.var_188 == null)
            {
               this.var_188 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_188.showOffer(this,param1,param2,param3,_loc4_);
         ...
         {
            this.var_417.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_290.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         return this.var_355.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_355.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_78)
         {
            _loc3_ = this.var_355.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_101.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_101.getActivityPointsForType(Purse.const_398)));
         var _loc1_:int = 0;
         if(!this.var_101.hasClubLeft)
         {
            _loc2_ = "catalog.purse.club.join";
         }
         else
         {
            if(this.var_101.isVIP)
            {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_101.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_101.clubPeriods));
         }
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_114,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_677)
         {
            if(!this.var_355.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_291.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_290 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_291 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_291.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_199,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               this.var_1420 = param1.session.isPrivateRoom;
               if(this.var_86 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_115 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_939 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_417 == null)
         {
            this.var_417 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_290.buildCatalogIndex(_loc2_);
         if(this.var_625 && this.var_625 != "")
         {
            this.var_290.openPage(this.var_625);
            this.var_625 = "";
            this.var_770 = -1;
         }
         else if(this.var_770 > -1)
         {
            this.var_290.openPageById(this.var_770,this.var_1421);
            this.var_770 = -1;
            this.var_1421 = -1;
            this.var_625 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_291.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_291 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_291.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_101.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_1898 && this.var_518 != null)
         {
            this.var_518.playSound(HabboSoundTypesEnum.const_1019);
         }
         this.var_1898 = false;
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_101.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_1896 && this.var_518 != null)
         {
            this.var_518.playSound(HabboSoundTypesEnum.const_1009);
         }
         this.var_1896 = false;
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_101.activityPoints = _loc2_.points;
         this.updatePurse();
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_101.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_101.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_101.isVIP = _loc2_.isVIP;
         this.var_101.pastClubDays = _loc2_.pastClubDays;
         this.var_101.pastVipDays = _loc2_.pastVipDays;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_939.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_291.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_115 != null)
         {
            this.var_115.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_115 != null)
         {
            this.var_115.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_115 != null)
         {
            this.var_115.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_1897 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_115.averagePricePeriod = _loc2_.averagePricePeriod;
      }
