   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      override public function init() : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_940.add(MarketPlaceOfferState.const_1004,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_940.add(MarketPlaceOfferState.const_484,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_940.add(MarketPlaceOfferState.const_186,_loc2_);
            }
         }
      ...
      private function updateList(param1:Map) : void
      {
         ...
         while(_loc7_ < _loc6_.length)
         {
            ...
            if(_loc11_.status == MarketPlaceOfferState.const_484)
            {
               _loc5_++;
            }
            _loc4_ = this.var_940.getValue(_loc11_.status);
            if(_loc4_)
            {
               ...
               if(!(!_loc12_ || _loc12_.disposed))
               {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_1004)
                  {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_186)
                  {
