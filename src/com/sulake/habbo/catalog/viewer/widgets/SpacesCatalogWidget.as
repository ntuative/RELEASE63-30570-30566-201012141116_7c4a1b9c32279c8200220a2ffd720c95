package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1757:String = "MakeOfferMessageComposer";
      ...
      private var _floorType:String = "MakeOfferMessageComposer";
      ...
      private var var_1758:String = "1.1";
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1370[this.var_388];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1368[this.var_390];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1369[this.var_391];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1758);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_904[this.var_388];
         ...
         _loc6_ = this.var_1368[this.var_390];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_905[this.var_391];
         for each(_loc1_ in this._configuration.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               ...
               if(_loc13_ != null)
               {
                  this.var_1758 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1369[this.var_391];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_196:
               ...
               if(this.var_388 < 0)
               {
                  this.var_388 = this.var_904.length - 1;
               }
               if(this.var_388 == this.var_904.length)
               {
                  this.var_388 = 0;
               }
               this.var_389 = 0;
               this.var_903 = 0;
               _loc5_ = this.var_904[this.var_388];
               for each(_loc8_ in this._configuration.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_903 = _loc8_.children().length();
                  }
               }
            ...
            case const_88:
               ...
               if(this.var_391 < 0)
               {
                  this.var_391 = this.var_905.length - 1;
               }
               if(this.var_391 >= this.var_905.length)
               {
                  this.var_391 = 0;
               }
               this.var_482 = 0;
               this.var_902 = 0;
               _loc7_ = this.var_905[this.var_391];
               for each(_loc10_ in this._configuration.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_902 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1757,this.var_1758,64,this,"window_romantic_wide");
         ...
         {
            this.var_1760 = _loc2_.id;
            this.var_1759 = _loc3_.id;
