package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_960:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_960.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         if(this.var_961 != null)
         {
            this.var_961.removeEventListener(WindowKeyboardEvent.const_148,this.windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         this.var_960 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_960 != null)
         {
            this.var_960.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_961 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_961 != null)
         {
            this.var_961.addEventListener(WindowKeyboardEvent.const_148,this.windowKeyEventProcessor);
         }
      }
