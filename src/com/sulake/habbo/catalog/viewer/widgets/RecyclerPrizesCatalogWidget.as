package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_941:PrizeViewer;
      
      private var _itemList:IItemListWindow;
      
      private var var_1428:XML;
      
      private var var_1429:XML;
      ...
      override public function init() : void
      {
         ...
         this.var_1429 = _loc1_.content as XML;
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1429) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1428) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         this.var_941.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
