package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1617:Point;
      
      private var var_458:IItemGridWindow;
      
      private var var_1273:IScrollbarWindow;
      ...
      {
         this.var_833 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1034 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_81 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1617 = new Point(this.var_81.x,this.var_81.y);
         this.var_458 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1273 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1618 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_458 != null)
         {
            this.var_458.visible = false;
            this.var_458.destroyGridItems();
         }
         if(this.var_1273 != null)
         {
            this.var_1273.visible = false;
         }
         ...
         this.var_833.text = _loc4_;
         this.var_1034.text = _loc5_;
         this.var_833.height = this.var_833.textHeight + 5;
         this.var_1034.y = this.var_833.y + this.var_833.height;
         this.var_1034.height = Math.max(130,this.var_1034.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_423:
                  _loc6_ = this.var_1618.clone();
                  if(this.var_458 != null)
                  {
                     this.var_458.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_458,this.var_1273,this.var_1428);
                     this.var_458.scrollV = 0;
                  }
                  break;
               case Offer.const_508:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_215:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           _loc16_ = _loc15_.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_48);
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_43,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_264,AvatarAction.const_409);
                              _loc16_.appendAction(AvatarAction.const_284,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2292)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2292 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_81 != null && true)
         {
            ...
            this.var_81.x = this.var_1617.x;
            this.var_81.y = this.var_1617.y;
            if(param3 != null)
            {
