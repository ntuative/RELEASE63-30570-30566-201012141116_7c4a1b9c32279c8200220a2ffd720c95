package com.sulake.habbo.catalog.viewer
{
   ...
   public class Offer implements IPurchasableOffer
   {
      ...
      public static const const_508:String = "pricing_model_single";
      
      public static const const_495:String = "pricing_model_multi";
      
      public static const const_423:String = "pricing_model_bundle";
      
      public static const const_1091:String = "price_type_none";
      
      public static const const_537:String = "price_type_credits";
      
      public static const const_605:String = "price_type_activitypoints";
      
      public static const const_598:String = "price_type_credits_and_activitypoints";
      ...
      public function Offer(param1:CatalogPageMessageOfferData, param2:ICatalogPage)
      {
         ...
         this.var_1613 = param1.localizationId;
         this.var_1029 = param1.priceInCredits;
         this.var_1028 = param1.priceInActivityPoints;
         this.var_1579 = param1.activityPointType;
         this.var_353 = param2;
      ...
      private function analyzePricingModel(param1:Array) : void
      {
         ...
         if(param1.length == 1)
         {
            ...
            {
               this.var_680 = const_508;
            }
            else
            {
               this.var_680 = const_495;
            }
         }
         else if(param1.length > 1)
         {
            this.var_680 = const_423;
         }
         else
         {
            this.var_680 = const_1261;
         }
      }
      
      private function analyzePriceType() : void
      {
         if(this.var_1029 > 0 && this.var_1028 > 0)
         {
            this.var_1030 = const_598;
         }
         else if(this.var_1029 > 0)
         {
            this.var_1030 = const_537;
         }
         else if(this.var_1028 > 0)
         {
            this.var_1030 = const_605;
         }
         else
         {
            this.var_1030 = const_1091;
         }
      }
   }
}
