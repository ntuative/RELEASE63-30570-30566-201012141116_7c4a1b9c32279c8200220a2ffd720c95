package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected var var_1882:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_941:ICatalogViewer;
      ...
      private var var_1384:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1385:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_1384 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1130);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1130);
      }
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_1882 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1882) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1487) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_1385 = new ItemGridCatalogWidget(_loc1_);
            this.var_58.push(this.var_1385);
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1269) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1424) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1292) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_58.push(new TrophyCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1303) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1392) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1501) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1322) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_58.push(new MarketPlaceCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1339) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1319) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_58.push(new ClubBuyCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1289) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = this.var_1384;
            _loc2_.init();
         }
         this.var_1384.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         return this.var_1384.dispatchEvent(param1);
      }
   }
}
