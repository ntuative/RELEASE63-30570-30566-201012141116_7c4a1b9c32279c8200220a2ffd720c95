package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_623:MarketPlaceLogic;
      ...
      private var var_84:MarketPlaceOfferData;
      ...
      public function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         ...
         this.var_84 = param2;
         if(!this.var_623 || !this._catalog || !this._catalog.localization)
         {
            return;
         }
         if(this._window)
         ...
         if(_loc3_)
         {
            if(param1 == this.var_623.const_1607)
            {
               _loc3_.text = "${catalog.marketplace.confirm_header}";
            }
            if(param1 == this.var_623.const_1710)
            {
         ...
         if(_loc3_)
         {
            _loc3_.text = "${" + this.var_623.getNameLocalizationKey(param2) + "}";
         }
         ...
         if(_loc3_)
         {
            ...
            _loc4_ = _loc4_.replace("%price%",this.var_84.price);
            _loc3_.text = _loc4_;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               _loc4_ = _loc5_.raw;
               _loc4_ = _loc4_.replace("%days%",this.var_623.averagePricePeriod.toString());
               _loc6_ = this.var_84.averagePrice == 0 ? " - " : this.var_84.averagePrice.toString();
         ...
         if(_loc3_)
         {
            ...
            {
               _loc4_ = _loc5_.raw;
               _loc4_ = _loc4_.replace("%count%",this.var_84.offerCount);
               _loc3_.text = _loc4_;
            }
            else
            {
      ...
      private function setImage() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         if(!this.var_84 || !this._window || !this._roomEngine)
         {
            return;
         }
         if(!this.var_84.image)
         {
            if(this.var_84.furniType == 1)
            {
               _loc1_ = this._roomEngine.getFurnitureIcon(this.var_84.furniId,this);
            }
            else if(this.var_84.furniType == 2)
            {
               _loc1_ = this._roomEngine.getWallItemIcon(this.var_84.furniId,this);
            }
            if(_loc1_ && _loc1_.data)
            {
               this.var_84.image = _loc1_.data as BitmapData;
               this.var_84.imageCallback = _loc1_.id;
            }
         }
         if(this.var_84.image != null)
         {
            ...
            if(_loc2_)
            {
               ...
               _loc2_.bitmap.draw(this.var_84.image,new Matrix(1,0,0,1,(_loc2_.width - this.var_84.image.width) / 2,(_loc2_.height - this.var_84.image.height) / 2));
            }
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "buy_button":
               this._catalog.buyMarketPlaceOffer(this.var_84.offerId);
               this.hide();
               break;
      ...
      {
         if(this.var_84 && this.var_84.imageCallback == param1)
         {
            this.var_84.image = param2;
            this.setImage();
         }
      }
