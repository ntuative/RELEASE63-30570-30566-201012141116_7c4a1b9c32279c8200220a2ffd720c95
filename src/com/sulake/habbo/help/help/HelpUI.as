package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1574:int = 0;
      
      private static const const_1575:int = 0;
      ...
      {
         this.var_322 = this._defaultViewId;
         this.var_473 = new Array();
         this.var_574 = new Array();
         super();
         this._component = param1;
         this._assetLibrary = param2;
         this._windowManager = param3;
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201012141110));
         this._toolbar = param5;
         this.var_96 = new Map();
         this.var_96.add(HabboHelpViewEnum.const_1364,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_162,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_459,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_291,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_235,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_669,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_361,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_624,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_243,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_96.add(HabboHelpViewEnum.const_1073,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_96.add(HabboHelpViewEnum.const_987,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_612,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_473.length == 0 || param1 != this.var_322)
            {
               this.var_473.push(this.var_322);
            }
         }
         this.var_322 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_322);
            return;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_243:
               ...
               break;
            case CallForHelpResultEnum.const_1083:
               this.showUI(HabboHelpViewEnum.const_987);
               break;
            case CallForHelpResultEnum.const_939:
               this.showUI(HabboHelpViewEnum.const_1073);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_96.getValue(HabboHelpViewEnum.const_162) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_417));
      }
      ...
      {
         return this.var_96.getValue(this.var_322);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1706 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1705;
         this._window.width = _loc1_.width + this.var_1706;
      }
      ...
      {
         if(this.var_473.length > 0)
         {
            this.showUI(this.var_473.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_322 == HabboHelpViewEnum.const_162)
         {
            return;
         }
         if(this.var_574.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_574.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_574.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_321.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_574[1],this.var_574[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_574[0],this.var_574[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_322 == HabboHelpViewEnum.const_162 || this.var_473.length == 0)
         {
            return;
         }
         if(this.var_321 == null)
         {
            ...
            this.var_321 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_321.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_321.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_321 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_321 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_321 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
