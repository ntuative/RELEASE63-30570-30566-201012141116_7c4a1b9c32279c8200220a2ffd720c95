package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_739:FaqCategory;
      ...
      {
         super();
         this.var_738 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_737 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_739 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function dispose() : void
      {
         ...
         if(this.var_149 != null)
         {
            ...
            {
               _loc2_ = this.var_149.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
      ...
      {
         var _loc4_:FaqCategory = this.var_149.getValue(param1);
      ...
      {
         var _loc4_:* = null;
         if(this.var_738.hasItem(param1))
         {
            this.var_738.getItem(param1).answerText = param2;
         }
         if(this.var_737.hasItem(param1))
         {
            this.var_737.getItem(param1).answerText = param2;
         }
         if(this.var_739.hasItem(param1))
         {
            this.var_739.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_149.length)
         {
            _loc4_ = this.var_149.getWithIndex(_loc3_);
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_738.hasItem(param1))
         {
            return this.var_738.getItem(param1);
         }
         if(this.var_737.hasItem(param1))
         {
            return this.var_737.getItem(param1);
         }
         if(this.var_739.hasItem(param1))
         {
            return this.var_739.getItem(param1);
         }
         var _loc2_:int = 0;
         while(_loc2_ < this.var_149.length)
         {
            _loc3_ = this.var_149.getWithIndex(_loc2_);
