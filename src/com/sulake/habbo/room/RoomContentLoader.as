package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_725:String = "RCL_LOADER_READY";
      
      private static const const_313:String = "RCL_PUBLICROOM_";
      
      private static const const_1580:int = 0;
      
      private static const const_881:int = 1;
      
      private static const name_2:int = 2;
      
      private static const const_392:String = "place_holder";
      
      private static const const_559:String = "wall_place_holder";
      
      private static const const_1239:String = const_392;
      
      private static const ROOM_CONTENT:String = "room";
      
      private static const const_879:String = "tile_cursor";
      
      private static const const_880:String = "selection_arrow";
      ...
      private var var_1381:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2496 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2495 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2500 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2497 = param2.getKey("public.room.dynamic.download.url","");
         this.var_2499 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = this.var_355.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_488.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_488.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_725.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_601.add(_loc3_,_loc4_);
               if(this.var_602.indexOf(_loc7_) < 0)
               {
                  this.var_602.push(_loc7_);
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_599.add(_loc3_,_loc4_);
               if(this._wallItems.indexOf(_loc7_) < 0)
               {
                  this._wallItems.push(_loc7_);
               }
            }
            _loc8_ = this.var_600.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_600.remove(_loc7_);
               this.var_600.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2494)
         {
            ...
            {
               this.var_1381.dispatchEvent(new Event(const_725));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_487 != null)
         {
            ...
            this.var_487.add(param1,param2);
         }
         if(this.var_489 != null)
         {
            this.var_489.remove(param2);
            this.var_489.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_487 != null)
         {
            _loc2_ = this.var_487.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_602.indexOf(param1) >= 0)
         {
         ...
         if(this.var_184 != null && (this.var_184.type == param1 || this.var_184.hasWorldType(param1)))
         {
         ...
         {
            return RoomObjectCategoryEnum.const_262;
         }
         return RoomObjectCategoryEnum.const_158;
      }
      ...
      {
         return [const_392,const_559,ROOM_CONTENT,const_879,const_880];
      }
      ...
      {
         var _loc3_:String = this.var_599.getValue(param1) as String;
      ...
      {
         var _loc2_:String = this.var_599.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function method_2(param1:String) : String
      {
      ...
      {
         if(this.var_184 != null && this.var_184.hasWorldType(const_313 + param1))
         {
            return this.var_184.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_160 || param1 == RoomObjectVisualizationEnum.const_64 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_27)
         {
            ...
            return int(this.var_600.getValue(param1));
         }
         return 0;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               {
                  _loc10_ = this.var_2499;
                  _loc10_ = _loc10_.replace(/%typeid%/,_loc7_[_loc9_]);
                  _loc8_.push(this.var_2497 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
                     if(this.var_602.indexOf(_loc4_) == -1)
                     {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_381,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1380.getValue(param1) != null)
         {
            this.var_184 = this.var_1380.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_569,this.onContentLoaded);
            _loc6_ = 0;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1483);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2496.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = this.getVisualizationXML(_loc5_);
               _loc8_ = this.extractPublicRoomFromXML(_loc5_,_loc7_);
               this.var_1380.add(_loc5_,_loc8_);
               this.var_184 = _loc8_;
               this.extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_381,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_532,_loc5_);
         }
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_726.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_726.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_488.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_726.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_488.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_488.add(_loc5_,_loc4_);
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_205 && _loc5_ != RoomObjectLogicEnum.const_160)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_415.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      private function method_5(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_313 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_313 + param1) == RoomObjectCategoryEnum.const_74)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_184.getWorldHeightScale(const_313 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_184 != null)
         {
            return this.var_184.getWorldScale(const_313 + param1);
         }
         return 32;
      }
