package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_857:int = 0;
      
      private static const const_1567:int = 1;
       
      
      private var var_1654:Vector3d = null;
      
      public function FurniturePushableLogic()
      {
         super();
         moveUpdateInterval = const_768;
         this.var_1654 = new Vector3d();
      }
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1654.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_1654).length == 0)
            {
               if(object.getState(0) != const_857)
               {
                  object.setState(const_857,0);
               }
            }
         }
      }
