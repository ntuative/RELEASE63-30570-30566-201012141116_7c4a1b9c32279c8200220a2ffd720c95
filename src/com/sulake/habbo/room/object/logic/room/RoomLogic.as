package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1436:int = 255;
      
      private var var_1230:uint = 16777215;
      
      private var var_1546:int = 255;
      
      private var var_983:uint = 16777215;
      
      private var var_1544:int = 255;
      
      private var var_984:int = 0;
      
      private var var_1545:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1022,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_630,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_794,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_685,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_984)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1436;
            if(_loc2_ - this.var_984 >= this.var_1545)
            {
               _loc3_ = this.var_983;
               _loc4_ = this.var_1544;
               this.var_984 = 0;
            }
            else
            {
               _loc7_ = this.var_1230 >> 16 & 255;
               _loc8_ = this.var_1230 >> 8 & 255;
               _loc9_ = this.var_1230 & 255;
               _loc10_ = this.var_983 >> 16 & 255;
               _loc11_ = this.var_983 >> 8 & 255;
               _loc12_ = this.var_983 & 255;
               _loc13_ = (_loc2_ - this.var_984) / this.var_1545;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1546 + (this.var_1544 - this.var_1546) * _loc13_;
               this._color = _loc3_;
               this.var_1436 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_630,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_746:
               param2.setString(RoomObjectVariableEnum.const_617,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_738:
               param2.setString(RoomObjectVariableEnum.const_603,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_711:
               param2.setString(RoomObjectVariableEnum.const_739,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_474:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_221)
               {
                  _loc5_ = "null";
               }
               this.var_499.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_667:
               _loc4_ = this.var_499.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_499.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1001,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_984:
               param2.setNumber(RoomObjectVariableEnum.const_794,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_938:
               param2.setNumber(RoomObjectVariableEnum.const_685,_loc3_);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_918,int(param1.bgOnly));
         this.var_1230 = this._color;
         this.var_1546 = this.var_1436;
         this.var_983 = _loc3_;
         this.var_1544 = _loc4_;
         this.var_984 = getTimer();
         this.var_1545 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_406,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1456,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1344,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1332,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_406,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_157 || _loc13_ == RoomPlaneData.const_277)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
