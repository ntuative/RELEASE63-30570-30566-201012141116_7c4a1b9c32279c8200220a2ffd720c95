package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      public static const const_66:int = 2;
      
      private static const const_1205:int = 3;
      ...
      {
         return param1 + param2 * const_1205;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_131,const_69,const_66,const_131,const_69,const_66];
                     _loc8_ = [const_69,const_69,const_69,const_66,const_66,const_66];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
