package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      public function FurniturePlanetSystemVisualization()
      {
         ...
         this.var_1969 = new Vector3d(0,0,0);
         super();
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            while(this.var_220.length > 0)
            {
               _loc1_ = this.var_220.shift();
               _loc1_.dispose();
            }
         }
         this.var_220 = null;
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         if(this.var_220 == null && spriteCount > 0)
         {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_220.length)
            {
               _loc2_ = this.var_220[_loc3_];
               _loc2_.update(this._offsetArray,this.var_1969,param1);
               _loc3_++;
            }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1042);
