package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1535:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2619:Number = NaN;
      
      protected var var_2618:int = -1;
      
      protected var _alphaMultiplier:Number = 1.0;
      
      protected var var_1172:String = null;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_1752 != spriteCount)
         {
            createSprites(this.var_1752);
         }
         var _loc4_:Boolean = false;
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc6_ != null && _loc6_.asset != null)
            {
               ...
               if(param1 < spriteCount - 1)
               {
                  ...
                  _loc5_.color = this.getSpriteColor(param1,this.var_2618,param2);
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_967:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1002:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_409 != _loc3_.getUpdateID() || param1 != var_251 || param2 != this.var_2619)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(var_215 != _loc3_.getUpdateID())
         {
            this.var_2618 = _loc3_.getNumber(RoomObjectVariableEnum.const_214);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_269));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1172 = _loc3_.getString(RoomObjectVariableEnum.const_371);
            if(this.var_1172 == null || this.var_1172.indexOf("http") != 0)
            {
               this.var_1172 = null;
            }
            var_215 = _loc3_.getUpdateID();
            return true;
         }
         return false;
      }
      ...
      {
         if(this.var_2548 != param1 || this.var_2549 != param2)
         {
            this.var_915 = [];
            this.var_914 = [];
            this.var_730 = [];
            ...
            this.var_1752 = this._data.getLayerCount(param2) + 1;
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param1 >= FurnitureVisualizationData.const_1086.length)
         {
            return "";
         }
         var _loc3_:String = this.var_915[param1];
         var _loc4_:Boolean = this.var_914[param1];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param1 < spriteCount - 1)
            {
               ...
               _loc6_ = FurnitureVisualizationData.const_1086[param1];
            }
            else
            {
               _loc6_ = "sd";
      ...
      {
         if(this.var_734[param1] != null && !this.var_1812)
         {
      ...
      protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         this.var_736[param1] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(this.var_735[param1] != null)
         {
