package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_316:int = 1000;
      ...
      private var var_1356:int = 360;
      
      private var var_710:DirectionData = null;
      
      private var var_240:Map;
      
      private var _colors:Map;
      
      private var var_1106:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_710 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_240 != null)
         {
            _loc2_ = null;
            _loc1_ = 0;
            while(_loc1_ < this.var_240.length)
            {
               _loc2_ = this.var_240.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_710,_loc3_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_240.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_710);
            this.defineDirection(_loc3_,_loc8_);
            this.var_240.add(String(_loc7_),_loc3_);
            this.var_1738 = -1;
            this.var_1106 = null;
            _loc5_++;
         }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         {
            param1.include(_loc7_,int(_loc4_) != 0);
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_967);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_1002);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1356 / 2) % 360 / this.var_1356;
         if(this.var_240.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < this.var_240.length)
         {
            _loc6_ = int(this.var_240.getKey(_loc5_)) * this.var_1356;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_240.getKey(_loc4_));
         }
         return const_1356;
      }
      ...
      {
         if(param1 == this.var_1738)
         {
            return this.var_1106;
         }
         var _loc2_:* = null;
         _loc2_ = this.var_240.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_710;
         }
         this.var_1738 = param1;
         this.var_1106 = _loc2_;
         return this.var_1106;
      }
