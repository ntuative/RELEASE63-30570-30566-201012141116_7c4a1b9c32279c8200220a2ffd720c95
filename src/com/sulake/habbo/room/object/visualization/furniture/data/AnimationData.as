   ...
   public class AnimationData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_111 != null)
         {
            ...
            {
               _loc2_ = this.var_111.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function getStartFrame() : int
      {
         ...
         return Math.random() * this.var_373;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         this.var_111.add(param1,_loc6_);
         var _loc11_:int = _loc6_.frameCount;
         if(_loc11_ > this.var_373)
         {
            this.var_373 = _loc11_;
         }
         return true;
      }
      ...
      {
         var _loc3_:AnimationLayerData = this.var_111.getValue(param1) as AnimationLayerData;
         if(_loc3_ != null)
         {
      ...
      {
         var _loc5_:AnimationLayerData = this.var_111.getValue(param1) as AnimationLayerData;
         if(_loc5_ != null)
         {
