package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1751:int = 1;
      
      public static const const_1624:int = 16777216;
      ...
      private var var_1801:int = 16777216;
      
      private var var_2652:int = 69069;
      
      private var var_2651:int = 5;
      ...
      {
         var _loc1_:int = this.var_2652 * this.var_1800 + this.var_2651;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1801;
         this.var_1800 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1801 * param2);
      }
   }
}
