package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1287:int = 16777215;
      
      public static const const_1509:int = 13421772;
      
      private static const const_884:int = 16777215;
      
      private static const const_885:int = 13421772;
      
      private static const const_882:int = 10066329;
      
      private static const const_883:int = 10066329;
      
      public static const const_1451:int = 16777215;
      
      public static const const_1463:int = 13421772;
      
      public static const const_1439:int = 10066329;
      ...
      private var var_746:Rectangle = null;
      
      private var var_499:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_2576:String = null;
      
      private var var_1143:uint = 16777215;
      
      private var var_2579:int = 255;
      
      private var var_2577:int = 255;
      
      private var var_2578:int = 255;
      ...
      private const const_1853:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_499 = new RoomPlaneBitmapMaskParser();
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_746 = super.boundingRectangle;
         }
         return new Rectangle(this.var_746.x,this.var_746.y,this.var_746.width,this.var_746.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_941);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_182)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1287;
               }
               else
               {
                  _loc13_.color = const_1509;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_157)
            {
               ...
               {
                  _loc13_.color = const_883;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_884;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_885;
               }
               else
               {
                  _loc13_.color = const_882;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_277)
            {
               ...
               {
                  _loc13_.color = const_1463;
               }
               else
               {
                  _loc13_.color = const_1439;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1275)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_108,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1853 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_340.length)
            {
               _loc10_ = this.var_612[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_340[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_88)
               {
                  if(this.var_1824)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2578 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2577 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2579 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1631)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1379 || _loc3_.y != this.var_2485 || _loc3_.z != this.var_2484 || param1.scale != this.var_2486))
            {
               this.var_1379 = _loc3_.x;
               this.var_2485 = _loc3_.y;
               this.var_2484 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1001);
            if(_loc3_ != this.var_2576)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2576 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_630));
            if(_loc4_ != this.var_1143)
            {
               this.var_1143 = _loc4_;
               this.var_2578 = this.var_1143 & 255;
               this.var_2577 = this.var_1143 >> 8 & 255;
               this.var_2579 = this.var_1143 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_918));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_215 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_603);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_617);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_739);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_794));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_685));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_592));
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_340;
         if(this.var_340.length == 0)
         {
            _loc6_ = this.var_119;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_340.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_340.push(_loc12_);
                        this.var_612.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1792;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_499.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_499.maskCount)
         {
            _loc10_ = this.var_499.getMaskType(_loc8_);
            _loc11_ = this.var_499.getMaskLocation(_loc8_);
            _loc12_ = this.var_499.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_119.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_108 || _loc3_.type == RoomPlane.const_88)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_108 || _loc3_.type == RoomPlane.const_88 && _loc12_ == RoomPlaneBitmapMaskData.const_221)
                              {
