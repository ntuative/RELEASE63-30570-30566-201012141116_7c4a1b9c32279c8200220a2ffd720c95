package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1199:uint = 1;
      ...
      private var var_840:ISkinContainer;
      
      private var var_311:Array;
      
      private var var_1288:IEventDispatcher;
      
      private var var_1055:Boolean = false;
      
      private var var_1642:ProfilerOutput;
      
      private var var_1289:ProfilerAgentTask;
      
      private var var_1290:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_840 = new SkinContainer(_loc4_.content as XML,assets);
         this._windowRenderer = new WindowRenderer(this.var_840);
         this.var_178 = new Array(const_389);
         ...
         {
            this.var_178[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_239 = this.var_178[const_1199];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this.var_239.getMouseCursor().defineCustomCursorType(MouseCursorType.const_352,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this.var_239.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1363,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1642)
            {
               this.var_1642 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1642.profiler = _loc3_;
            this.var_1289 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1289);
            this.var_1290 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1290);
            this.var_1055 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_178)
            {
               ...
               {
                  IDisposable(this.var_178.pop()).dispose();
               }
            }
            this.var_178 = null;
            if(this.var_311)
      ...
      {
         return this.var_239.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_239.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_840.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_178[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_178[param2].getDesktopWindow();
      ...
      {
         return this.var_178[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_178[param1].getDesktopWindow().getChildAt(this.var_239.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_178[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_344.length > 0)
         {
            this.var_1288.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_389 - 1;
            while(_loc2_ >= 0)
            {
               this.var_178[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1055)
         ...
         this.var_1288.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_389)
         {
            this.var_178[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1055)
         {
         ...
         if(WindowContext.var_344.length > 0)
         {
            WindowContext.var_344.flush();
         }
         this.var_1288.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1378,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1313,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1337,param2.name + ": " + param2.toString());
            }
         }
      }
   }
