package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1571:String = "noconvinfo";
      
      private static const const_1570:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1308:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1308 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this._friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.FRIENDLIST,this.var_17));
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_866 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_237 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1308.prepare(this.var_866);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_989,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1085,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_647,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_773,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_647,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_773,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1309 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1309.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1672 == -1 ? 0 : int(this.var_17.height - this.var_1672);
         var _loc4_:int = this.var_1671 == -1 ? 0 : int(this.var_17.width - this.var_1671);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_237.y = Util.getLowestPoint(this.var_17.content);
         this.var_237.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1115,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_647,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_989,false);
         ...
         this.var_1672 = this.var_17.height;
         this.var_1671 = this.var_17.width;
