package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_156:String = "face";
      ...
      private var var_121:IHabboMessenger;
      
      private var _configuration:IHabboConfigurationManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_970:IAvatarRenderManager;
      
      private var var_665:ISessionDataManager;
      
      private var var_2159:FriendListLookAndFeel;
      
      private var var_370:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1542:OpenedToWebPopup;
      
      private var var_1948:int;
      
      var var_91:FriendCategories;
      
      private var var_301:FriendRequests;
      
      private var var_1541:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_868:IHabboNotifications;
      
      private var var_529:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2159 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_91 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1541 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_529.stop();
            this.var_529.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_529 = null;
         }
         ...
         if(this.var_121)
         {
            this.var_121.release(new IIDHabboMessenger());
            this.var_121 = null;
         }
         ...
         if(this.var_970)
         {
            this.var_970.release(new IIDAvatarRenderManager());
            this.var_970 = null;
         }
         if(this.var_868)
         {
            this.var_868.release(new IIDHabboNotifications());
            this.var_868 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_665)
         {
            this.var_665.release(new IIDSessionDataManager());
            this.var_665 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1542 = new OpenedToWebPopup(this);
         }
         this.var_1542.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_301.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_273,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_970.createAvatarImage(param1,AvatarScaleType.const_80,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_121 = param2 as IHabboMessenger;
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_970 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_868 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_301 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         ...
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_375,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_91.addFriend(new Friend(_loc4_));
         }
         this.var_370 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_529)
         {
            this.var_529 = new Timer(120000);
            this.var_529.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_529.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_114,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_91.findCategory(FriendCategory.const_375);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_370.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_373));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_301.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_301.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_370.findTab(FriendListTab.const_93).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_301.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_370.findTab(FriendListTab.const_93);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1541.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_370.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_665 || !this.var_301)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_665.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_301.vipLimit;
         }
         else if(this.var_665.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_301.clubLimit;
         }
         if(_loc2_ > this.var_301.limit)
         {
            this.var_301.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_156) as IBitmapWrapperWindow;
