package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1555:String = "no_reqs_info";
      ...
      private var var_1534:IContainerButtonWindow;
      ...
      {
         this.var_1533 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1534 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1534.procedure = this.onDismissAllButtonClick;
         this.var_1533.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         this.var_51.addListItem(param1.view);
         this._friendList.friendRequests.refreshShading();
         this.refreshButtons();
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         this.var_51.removeListItem(param1.view);
         this.refreshButtons();
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_333;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_357;
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_280,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_333 && _loc4_.state != FriendRequest.const_357)
            {
               _loc4_.state = FriendRequest.const_357;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_280,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_333 && _loc4_.state != FriendRequest.const_357)
            {
               ...
               _loc4_.state = FriendRequest.const_333;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1533,_loc1_);
         this.setEnabled(this.var_1534,_loc1_);
      }
