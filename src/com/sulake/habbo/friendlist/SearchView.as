package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_662:ITextFieldWindow;
      ...
      {
         this.var_662 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_662.procedure = this.onSearchInput;
         this.var_662.addEventListener(WindowKeyboardEvent.const_148,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_51.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_363,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      {
         var _loc10_:IWindowContainer = this.var_51.getListItemAt(param2) as IWindowContainer;
         if(_loc10_ == null)
         {
            if(!param1)
            {
            ...
            this.var_51.addListItem(_loc10_);
         }
         if(param1)
         {
            _loc10_.height = 20;
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_372.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_372.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function findIndexFor(param1:int) : int
      {
         ...
         {
            if(this.var_51.getListItemAt(_loc2_).id == param1)
            {
               return _loc2_;
            }
            _loc2_++;
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         {
            _loc5_ = 25;
            _loc6_ = this.var_662.text;
            if(_loc6_.length > _loc5_)
            {
               this.var_662.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_662.text;
