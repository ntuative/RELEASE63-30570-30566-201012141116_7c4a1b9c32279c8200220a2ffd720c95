package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_917:String = "issue_bundle_open";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_553 = new IssueBrowser(this,this.var_61.windowManager,this.var_61.assets);
         this.var_1051 = [];
         this.var_1052 = [];
      ...
      {
         var _loc4_:IssueBundle = this.var_93.getValue(param1) as IssueBundle;
         if(_loc4_ == null)
         {
            return;
         }
         this.sendPick(_loc4_.getIssueIds(),param2,param3);
         this.var_1051 = this.var_1051.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = this.var_93.getValues();
         for each(_loc5_ in _loc3_)
         {
            if(_loc5_.state == IssueMessageData.const_143 && (_loc4_ == null || _loc5_.getPrioritySum() > _loc4_.getPrioritySum()))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_356 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      public function releaseBundle(param1:int) : void
      {
         ...
         var _loc2_:IssueBundle = this.var_93.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_553 == null || !this.var_553.isOpen())
         {
            this.var_61.soundManager.playSound(HabboSoundTypesEnum.const_1018);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_836.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_93.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     this.var_93.remove(_loc3_.id);
                     this.removeHandler(_loc3_.id);
                  }
                  this.var_836.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         ...
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_93)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_836.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2307++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_836.add(param1.issueId,_loc2_);
            this.var_93.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(this.var_1051.indexOf(param1.issueId) != -1)
         {
            this.handleBundle(_loc3_.id);
            _loc5_ = this.var_61.sessionDataManager.userId;
            if(_loc5_ != param1.pickerUserId)
            {
               if(param1.state == IssueMessageData.const_356)
               {
         ...
         {
            _loc6_ = this.getBundles(const_614);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1052.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities() : void
      {
         ...
         var _loc3_:int = parseInt(this.var_61.configuration.getKey("chf.score.updatefactor","60"));
      ...
      {
         var _loc2_:IssueHandler = this.var_685.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_685.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_836.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_93.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
         ...
         for each(_loc4_ in this.var_93)
         {
            switch(param1)
            {
               case const_917:
                  ...
                  break;
               case const_614:
                  if(_loc4_.state == IssueMessageData.const_356 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_685.remove(param1);
         this.var_685.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_685.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      {
         var _loc3_:IssueBundle = this.var_93.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = this.var_93.getValues();
         var _loc4_:int = this.var_61.sessionDataManager.userId;
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.state == IssueMessageData.const_356 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            _loc8_ = null;
            for each(_loc9_ in this.var_93)
            {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_685.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
