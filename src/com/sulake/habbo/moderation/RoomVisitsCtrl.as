package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_2437:IWindowContainer;
      ...
      {
         this.var_2437 = IWindowContainer(this.var_46.getXmlWindow("roomvisits_row"));
         this.var_436 = new Timer(300,1);
         this.var_436.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
         this.var_46.messageHandler.addRoomVisitsListener(this);
         this.var_46.connection.send(new GetRoomVisitsMessageComposer(this._userId));
         this._frame = IFrameWindow(this.var_46.getXmlWindow("roomvisits_frame"));
         this.var_51 = IItemListWindow(this._frame.findChildByName("visits_list"));
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         this.var_46.messageHandler.removeRoomVisitsListener(this);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1411;
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_2437.clone());
         ...
         new OpenRoomTool(this._frame,this.var_46,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
         ...
         new OpenRoomInSpectatorMode(this.var_46,_loc7_,param1.isPublic,param1.roomId);
         _loc7_.color = _loc4_;
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(this.var_51.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = this.var_51.scrollableRegion.height > this.var_51.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
               _loc3_.visible = false;
               this.var_51.width += 17;
            }
         }
         else if(_loc4_)
         {
