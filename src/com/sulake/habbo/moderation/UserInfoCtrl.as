package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_834:int = 60;
      
      private static const const_835:int = 3600;
      
      private static const const_836:int = 86400;
      
      private static const const_837:int = 31536000;
      ...
      public function UserInfoCtrl(param1:IFrameWindow, param2:ModerationManager, param3:String, param4:Boolean = false)
      {
         ...
         this.var_1000 = param4;
      }
      
      public static function formatTime(param1:int) : String
      {
         if(param1 < 2 * const_834)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_835)
         {
            return Math.round(param1 / const_834) + " mins ago";
         }
         if(param1 < 2 * const_836)
         {
            return Math.round(param1 / const_835) + " hours ago";
         }
         if(param1 < 2 * const_837)
         {
            return Math.round(param1 / const_836) + " days ago";
         }
         return Math.round(param1 / const_837) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_999.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_46.getXmlWindow("user_info"));
            this.var_999.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_46,WindowTracker.const_926,this._data.userId),this._callerFrame,this.var_1000,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new RoomVisitsCtrl(this.var_46,this._data.userId),this._callerFrame,this.var_1000,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new SendMsgsCtrl(this.var_46,this._data.userId,this._data.userName,this.var_1291),this._callerFrame,this.var_1000,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new ModActionCtrl(this.var_46,this._data.userId,this._data.userName,this.var_1291),this._callerFrame,this.var_1000,false,true);
      }
