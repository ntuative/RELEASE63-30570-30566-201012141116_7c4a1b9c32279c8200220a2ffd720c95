package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_830:ICheckBoxWindow;
      
      private var var_1270:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_46.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_317));
         Logger.log("BEGINNING TO SHOW: " + this.var_317);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1503;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_317);
         if(param1.flatId != this.var_317)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_317);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_830 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1270 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1271 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_46,WindowTracker.const_821,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_830.isSelected);
         this.var_46.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1358,_loc2_,this.var_460.text,"",""));
         if(this.var_1270.isSelected || this.var_1271.isSelected || this.var_830.isSelected)
         {
            this.var_46.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1270.isSelected,this.var_1271.isSelected,this.var_830.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1298);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1521);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_46.initMsg.roomMessageTemplates[this.var_1025.selection];
         if(_loc3_ != null)
         {
            this.var_580 = false;
