package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      public function show() : void
      {
         if(this._frame == null)
         {
            this._frame = IFrameWindow(this.var_46.getXmlWindow("start_panel"));
            ...
            this._frame.findChildByName("room_tool_but").disable();
            this._frame.findChildByName("chatlog_but").disable();
            this.var_46.disableButton(this.var_46.initMsg.cfhPermission,this._frame,"ticket_queue_but");
      ...
      {
         if(this.var_46.initMsg.chatlogsPermission)
         {
      ...
      private function onRoomToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new RoomToolCtrl(this.var_46,this._roomId),this._frame,false,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!this.var_1422 ? 0 : 1,this._roomId),this.var_46,WindowTracker.const_821,this._roomId),this._frame,false,false,true);
      }
      ...
      private function onUserinfoButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new UserInfoFrameCtrl(this.var_46,this._userId),this._frame,false,false,true);
      }
