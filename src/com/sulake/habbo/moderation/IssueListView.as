package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_1562:IWindowContainer;
      
      private var var_2674:BitmapData;
      
      private var var_2675:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_1562 = this.var_553.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || this.var_1562 == null)
            {
               return;
            }
            _loc2_ = this.var_1562.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            _loc2_.width = this.var_51.width;
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = this.var_553.assets.getAssetByName(_loc8_) as BitmapDataAsset;
