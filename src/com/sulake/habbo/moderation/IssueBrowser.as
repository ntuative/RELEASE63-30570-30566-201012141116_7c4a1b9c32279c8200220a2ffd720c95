package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1848:String = "my_issues";
      
      private const const_1849:String = "open_issues";
      
      private const const_1847:String = "picked_issues";
      
      private const const_1856:String = "closed_issues";
      ...
      private var var_1779:IIssueBrowserView;
      
      private var var_1777:IIssueBrowserView;
      
      private var var_1778:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_243 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_243.numTabItems)
            {
               _loc5_ = this.var_243.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_58,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_243 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_243 == null || this.var_243.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_243.selector.getSelectableByName("open_issues");
         this.var_243.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_330.view.width = this.var_243.container.width;
         this.var_330.view.height = this.var_243.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1848:
               ...
               {
                  this.var_1779 = new MyIssuesView(this.issueManager,this,this.var_243.container);
               }
               return this.var_1779;
            case this.const_1849:
               if(this.var_1777 == null)
               {
                  this.var_1777 = new OpenIssuesView(this.issueManager,this,this.var_243.container);
               }
               return this.var_1777;
            case this.const_1847:
               if(this.var_1778 == null)
               {
                  this.var_1778 = new PickedIssuesView(this.issueManager,this,this.var_243.container);
               }
