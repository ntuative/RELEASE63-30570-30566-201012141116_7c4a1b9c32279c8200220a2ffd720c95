package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1788:IMessageComposer;
      ...
      private var var_1561:Dictionary;
      ...
      {
         this.var_993 = IWindowContainer(this.var_46.getXmlWindow("chatlog_roomheader"));
         this.var_994 = IWindowContainer(this.var_46.getXmlWindow("chatlog_chatline"));
         this.var_436 = new Timer(300,1);
         this.var_436.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
         this._frame = IFrameWindow(this.var_46.getXmlWindow("chatlog_frame"));
         this.var_51 = IItemListWindow(this._frame.findChildByName("chatline_list"));
         this._frame.procedure = this.onWindow;
         var _loc1_:IWindow = this._frame.findChildByTag("close");
         _loc1_.procedure = this.onClose;
         this.var_46.connection.send(this.var_1788);
         this.var_46.messageHandler.addChatlogListener(this);
      }
      ...
      public function onChatlog(param1:String, param2:int, param3:int, param4:Array, param5:Dictionary) : void
      {
         ...
         this.var_46.messageHandler.removeChatlogListener(this);
         this._frame.caption = param1;
         this.var_100 = param4;
         this.var_1561 = param5;
         this.populate();
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(this.var_993.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(this._frame,this.var_46,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
         ...
         this.var_51.addListItem(_loc2_);
         var _loc4_:* = true;
         for each(_loc5_ in param1.chatlog)
         {
            this.populateChatline(this.var_51,_loc5_,_loc4_);
            _loc4_ = !_loc4_;
         }
      }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_994.clone());
         _loc4_.color = this.var_1561[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(this._frame,this.var_46,_loc6_,param2.chatterId);
         }
      ...
      private function refreshListDims() : void
      {
         ...
         {
            _loc2_ = IWindowContainer(this.var_51.getListItemAt(_loc1_));
