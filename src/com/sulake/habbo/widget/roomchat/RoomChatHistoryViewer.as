package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1203:int = 18;
      
      private static const SCROLLBAR_WIDTH:int = 20;
      
      public static const const_1041:int = 3;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_161.state = RoomChatHistoryPulldown.const_209;
         ...
         this.var_43 = param2.createWindow("chatscroller","",HabboWindowType.const_1024,HabboWindowStyle.const_37,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_161.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_209);
      }
      ...
      {
         return !!this.var_374 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_161.state == RoomChatHistoryPulldown.const_318 || this.var_161.state == RoomChatHistoryPulldown.const_418;
      }
      ...
      {
         if(!this.var_374 && !this.var_1483)
         {
            this.var_374 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_161.state = RoomChatHistoryPulldown.const_318;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_43 != null)
         {
            ...
            if(param2)
            {
               this.var_43.scrollV = this.var_556;
            }
         }
         if(this.var_161 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_375 > 0 && param2)
         {
            if(this.var_1651)
            {
               if(Math.abs(param1 - this.var_375) <= const_1041)
               {
                  return;
               }
               this.var_1651 = false;
            ...
            if(this.var_374)
            {
               ...
               _loc5_ = (param1 - this.var_375) / this.var_43.height;
               _loc3_ = this.var_556 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_375;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_43.scrollV < 1 - const_1203 / this.var_43.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1650)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_43 != null)
         {
            this.var_556 = this.var_43.scrollV;
         }
         if(this.var_43 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_556 - this.var_43.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
