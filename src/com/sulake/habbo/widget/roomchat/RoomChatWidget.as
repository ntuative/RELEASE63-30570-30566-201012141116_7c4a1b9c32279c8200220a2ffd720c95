package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1252:int = 9;
      
      private static const const_886:int = 10;
      
      private static const const_561:int = 25;
      
      private static const const_1198:int = 25;
      
      private static const const_887:int = 4000;
      
      private static const const_1253:int = 6000;
      
      private static const const_1250:int = 3;
      
      private static const const_1251:int = 1;
      
      private static const const_560:int = 8;
      
      private static const const_394:int = 0;
      
      private static const const_888:int = (const_560 + const_394) * const_101 + const_101;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         this.var_35 = param1.createWindow("chat_container","",HabboWindowType.const_54,HabboWindowStyle.const_34,HabboWindowParam.const_37,new Rectangle(0,0,200,this.var_210 + RoomChatHistoryPulldown.const_76),null,0) as IWindowContainer;
         this.var_35.background = true;
         this.var_35.color = 33554431;
         this.var_35.tags.push("room_widget_chat");
         this.var_341 = param1.createWindow("chat_contentlist","",HabboWindowType.const_958,HabboWindowStyle.const_37,0 | 0,new Rectangle(0,0,200,this.var_210),null,0) as IItemListWindow;
         this.var_35.addChild(this.var_341);
         this.var_113 = param1.createWindow("chat_active_content","",HabboWindowType.const_54,HabboWindowStyle.const_37,HabboWindowParam.const_57,new Rectangle(0,0,200,this.var_210),null,0) as IWindowContainer;
         this.var_113.clipping = false;
         this.var_341.addListItem(this.var_113);
         this.var_27 = new RoomChatHistoryViewer(this,param1,this.var_35,param2);
         this.var_2585 = param4.getKey("site.url");
         this.var_2582 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      override public function dispose() : void
      {
         ...
         while(this.var_250.length > 0)
         {
            _loc1_ = this.var_250.shift();
         }
         this.var_27.dispose();
         this.var_27 = null;
      ...
      {
         var _loc2_:int = 0;
         if(getTimer() > this.var_1145 && this.var_1145 > 0)
         {
            this.var_1145 = -1;
            this.animationStart();
         }
         if(this.var_807)
         {
            _loc2_ = param1 / const_1198 * const_1250;
            if(_loc2_ + this.var_920 > this.var_919)
            {
               _loc2_ = this.var_919 - this.var_920;
            }
            if(_loc2_ > 0)
            {
            ...
            if(this.var_920 >= this.var_919)
            {
               this.var_919 = const_101;
               this.var_920 = 0;
               this.animationStop();
               this.processBuffer();
               this.var_1145 = getTimer() + const_887;
            }
         }
         if(this.var_27 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_633,this.onChatMessage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_633,this.onChatMessage);
      ...
      {
         var _loc2_:RoomChatItem = new RoomChatItem(this,windowManager,assets,this.getFreeItemId(),localizations,this.var_2585);
         _loc2_.define(param1);
         if(this.var_921 != 1)
         {
            _loc2_.senderX /= this.var_921;
         }
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(this.var_1826 == 0)
            {
               this.var_1826 = param1.scale;
            }
            else
            {
               this.var_921 = param1.scale / this.var_1826;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_747.x += param1.positionDelta.x / this.var_921;
            this.var_747.y += param1.positionDelta.y / this.var_921;
         }
         if(param1.rect != null)
         {
            if(this.var_27 == null)
            ...
            this.var_35.height = this.var_210 + this.var_27.pulldownBarHeight;
            this.var_341.width = this.var_35.width - this.var_27.scrollbarWidth;
            this.var_341.height = this.var_210;
            this.var_341.x = this.var_35.x;
            this.var_341.y = this.var_35.y;
            this.var_113.width = this.var_35.width - this.var_27.scrollbarWidth;
            this.var_113.height = this.var_210;
      ...
      private function processBuffer() : void
      {
         ...
         while(this.var_66.length > const_1251 || this.historyViewerActive() && this.var_66.length > 0)
         {
         ...
         else
         {
            ...
            {
               this.var_919 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_66[0]);
            }
            else
            {
               this.var_919 = const_101;
      ...
      private function activateItemFromBuffer() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc1_.aboveLevels > const_560 + const_394 + 2)
               {
                  _loc1_.aboveLevels = const_560 + const_394 + 2;
               }
               this.var_748 = 0;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_394 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1253)
               {
      ...
      private function moveItemsUp(param1:int) : void
      {
         ...
         var _loc2_:* = null;
         var _loc4_:int = -1;
         var _loc5_:int = this.var_250.length - 1;
         while(_loc5_ >= 0)
         {
            _loc2_ = this.var_250[_loc5_];
            if(_loc2_ != null)
            {
               if(_loc4_ == -1)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + this.var_747.x) * this.var_921;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_35.width / 2 - const_886;
         var _loc6_:Number = this.var_35.width / 2 + const_886 - this.var_27.scrollbarWidth;
      ...
      private function getAreaBottom() : Number
      {
         ...
         return this.var_210 + this.var_35.y;
      }
      ...
      private function purgeItems() : void
      {
         ...
         while(this._itemList.length > this.var_2582)
         {
            ...
            _loc3_ = this.var_250.indexOf(_loc2_);
            if(_loc3_ > -1)
            {
               this.var_250.splice(_loc3_,1);
            }
            if(_loc2_.view != null)
            {
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         this.var_210 = param1 - this.var_35.y;
         this.var_35.height = this.var_210 + RoomChatHistoryPulldown.const_76;
         if(this.var_27 != null)
         {
            this.var_27.containerResized(this.var_35.rectangle);
         }
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_210 = const_888 + const_393;
         this.var_35.height = this.var_210 + this.var_27.pulldownBarHeight;
         this.var_341.width = this.var_35.width - this.var_27.scrollbarWidth;
         this.var_341.height = this.var_210;
         this.var_113.width = this.var_35.width - this.var_27.scrollbarWidth;
         if(this.historyViewerActive())
         {
            this.var_113.height = this.getTotalContentHeight() + const_393;
         }
         else
         {
            this.var_113.height = this.var_210;
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_1041)
         {
            this.resetArea();
            return;
         }
      ...
      public function mouseUp() : void
      {
         ...
         if(_loc1_ < const_888)
         {
            if(_loc1_ <= this.var_210 + this.var_35.y)
            {
               if(this.historyViewerActive())
               {
                  this.hideHistoryViewer();
         ...
         if(this.var_1827 && !this.historyViewerActive())
         {
            this.resetArea();
            this.var_1827 = false;
         }
