package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_135["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_135["dance_icon"] = ["dance_white","dance_color"];
         this.var_135["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_135["effects_icon"] = ["effects_white","effects_color"];
         this.var_135["badges_icon"] = ["badges_white","badges_color"];
         this.var_135["wave_icon"] = ["wave_white","wave_color"];
         this.var_135["hc_icon"] = ["_white","_color"];
         this.var_135["settings_icon"] = ["settings_white","settings_color"];
         this.var_135["credits_icon"] = ["credits_white","credits_color"];
         this.var_135["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            this.var_135[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_135[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_135)
         {
            _loc6_ = this.var_135[_loc3_];
            if(!(_loc6_ == null || _loc6_.length == 0))
            {
               ...
               switch(_loc3_)
               {
                  ...
                  case "hc_icon":
                     ...
                     {
                        if(this._widget.habboClubLevel == HabboClubLevelEnum.const_51)
                        {
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1008);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_970));
            ...
            case "effects":
               ...
               this._widget.changeView(MeMenuWidget.const_664);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_911));
               this._widget.hide();
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_263);
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_895));
               this._widget.hide();
               break;
            case "settings":
               this._widget.changeView(MeMenuWidget.const_726);
               break;
            case "news":
