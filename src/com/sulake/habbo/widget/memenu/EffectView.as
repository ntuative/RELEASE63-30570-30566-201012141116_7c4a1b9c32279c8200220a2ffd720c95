package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_848:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_176 = new Timer(1000);
         this.var_176.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_176.stop();
            this.var_176.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_176 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            if(this.var_162.isActive)
            {
               _loc2_ = this.var_162.secondsLeft / Number(this.var_162.duration);
               this.var_846.width = _loc2_ * this.var_442;
            }
            else
            {
      ...
      private function setTimeLeft() : void
      {
         ...
         if(this.var_847 != null)
         {
            ...
            if(this.var_162.isActive)
            {
               _loc2_ = this.var_162.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         if(this.var_162.isInUse)
         {
            _loc3_ = "memenu_effect_selected";
         }
         else if(this.var_162.isActive)
         {
         ...
         else
         {
            ...
            this.var_848 = this._window.findChildByName("effect_hilite");
         ...
         if(this.var_846 != null)
         {
            this.var_442 = this.var_846.width;
            this.var_176.start();
            this.onUpdate();
         }
         if(this.var_162.icon)
         {
            this.setElementBitmap("effect_icon",this.var_162.icon);
         }
      }
