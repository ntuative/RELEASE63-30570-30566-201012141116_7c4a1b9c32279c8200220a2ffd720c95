package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1832:int = 5;
      
      private const const_1831:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_133:Function;
      
      private var _offsetX:int;
      
      private var var_1036:int;
      
      private var var_1037:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1036 = 0;
         this.var_1037 = param2.rectangle.clone();
         this.var_1037.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1037.width)
         {
            return false;
         }
         if(this.var_1036 + param1.height > this.var_1037.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1037.width)
         {
            this._offsetX = 0;
            this.var_1036 += param1.height + this.const_1831;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1036);
         this._offsetX += param1.width + this.const_1832;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1399 != null && this.var_1399.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_133);
