package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_1323:Map;
      
      private var var_571:int;
      
      private const const_1838:int = 158;
      
      private const const_1845:int = 16;
      
      private const const_1844:uint = 11184810;
      
      private const const_1842:uint = 6710886;
      
      private const const_1837:uint = 3355443;
      
      private const const_1840:String = "level";
      
      private const const_1841:String = "experience";
      ...
      {
         if(this.var_50 == null || this.var_212 == null || this.var_63 == null)
         {
            return;
         }
         ...
         this.var_212.height = this.var_50.height + 20;
         this._window.width = Math.max(this.var_212.width,this.var_63.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_212.width < this.var_63.width)
         {
            this.var_212.x = this._window.width - this.var_212.width;
            this.var_63.x = 0;
         }
         else
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1840,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1841,param1.experience,param1.experienceMax);
         ...
         this.updateWindow();
         this.var_571 = param1.id;
         this.var_1323.remove(param1.id);
         this.var_1323.add(param1.id,param1);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1838,this.const_1845,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1844);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1837);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1842);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this.var_1323.getValue(this.var_571) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_212 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_212 != null)
         {
            this.var_50 = this.var_212.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         this._widget.mainContainer.addChild(this._window);
         var _loc3_:IWindow = this.var_212.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_212.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_181 && this.var_181.getPetId() == this.var_571)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_447,this._widget.petData.ownerId);
