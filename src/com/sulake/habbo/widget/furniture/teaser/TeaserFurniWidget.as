package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private var var_304:int = -1;
      
      private const const_1542:int = 0;
      
      private const const_1540:int = 1;
      
      private const const_1539:int = 2;
      
      private const const_1541:int = 3;
      
      private const const_1815:int = 0;
      
      private const const_1814:int = 1;
      
      private const const_1816:int = 2;
      
      private const const_1813:String = "xmas10_dialog_bg_png";
      
      private const const_1538:String = "xmas10_dialog_telepair_png";
      
      private const const_1130:String = "xmas10_present_dialog_img_png";
      
      private const const_1812:String = "xmas10_dialog_newbiegift_png";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_530,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_787,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_691,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_530,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_530:
               _loc2_ = this.const_1542;
               this.var_1182 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_691:
               _loc3_ = param1.firstClickUserName;
               if(_loc3_ && _loc3_ != "")
               {
                  _loc2_ = this.const_1541;
                  this._localizations.registerParameter("widget.furni.teaser.notify.unlocked.desc","username",_loc3_);
               }
               else
               {
                  _loc2_ = this.const_1539;
               }
               this.var_1182 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_787:
               _loc2_ = this.const_1540;
               this.var_304 = param1.objectId;
               this.var_1182 = param1.data;
         ...
         if(this.var_1183 != _loc2_ && this._window)
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_1183 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
      ...
      override public function get mainWindow() : IWindow
      {
         ...
         if(!this._window)
         {
            switch(this.var_1183)
            {
               ...
               case this.const_1540:
                  ...
                  else if(this._status == this.const_1814)
                  {
                     ...
                     _loc2_ = this.const_1538;
                  }
                  else if(this._status == this.const_1816)
                  {
            ...
            if(_loc4_)
            {
               _loc3_ = (assets.getAssetByName(this.const_1813) as BitmapDataAsset).content as BitmapData;
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_582);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         HabboWebTools.facebookViralGiftPost(_loc2_,_loc3_,this.var_1182);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_145);
            _loc2_.objectId = this.var_304;
            messageListener.processWidgetMessage(_loc2_);
         }
         this.hideInterface();
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_731,"ViralGift",param1,param2,param3);
