package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_833:int = 16;
      
      private static const const_1172:int = 40;
      
      private static const const_1557:int = 5;
      ...
      private var var_442:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_992 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2180 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this._chatModeIdSpeak = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_812 = new Timer(1000,1);
         this.var_812.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_991 = new Timer(5000,1);
         this.var_991.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2179 = _loc2_.width + const_833 + _loc6_.width + const_1171;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1172,_loc8_.width) + const_833);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_442 = param1 - this.var_2179;
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),this.var_442);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,this.var_442);
         }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_992 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_448 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_448.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_448 = _loc2_.text;
            if(!this.var_811)
            {
               this.var_811 = true;
               this.var_812.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_811);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_442)
         {
