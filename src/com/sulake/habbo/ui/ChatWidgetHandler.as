package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_350:Map = null;
      
      private var var_349:Map = null;
      
      private var var_769:Map = null;
      
      private var _connection:IConnection = null;
      
      private var var_938:Number = 0.0;
      
      private var var_624:Point = null;
      ...
      public function ChatWidgetHandler()
      {
         ...
         super();
         this.var_350 = new Map();
         this.var_349 = new Map();
         this.var_769 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_350 != null)
         {
            ...
            {
               _loc2_ = this.var_350.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_349 != null)
         {
            ...
            {
               _loc2_ = this.var_349.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_720,RoomWidgetChatSelectAvatarMessage.const_653];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_720:
               if(this._container != null && this._container.roomSession != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     {
                        case RoomWidgetChatMessage.const_139:
      ...
      {
         return [RoomSessionChatEvent.const_170];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_170:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_349.getValue(_loc16_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_350.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_769.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_207:
                                       _loc17_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc16_,AvatarScaleType.const_80,this);
                                       if(_loc17_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_80,null,this);
                                       if(_loc17_ != null)
                                       {
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_207)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_349.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    this.var_350.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_769.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_938 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_938);
            }
            if(this.var_624 == null)
            {
               ...
               this.var_416.y = 0;
               this.var_416.z = 0;
               this.var_624 = _loc4_.getScreenPoint(this.var_416);
               this.var_938 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_416.x = 0;
            this.var_416.y = 0;
            this.var_416.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_416);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_624.x || _loc8_.y != this.var_624.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_624,_loc5_));
