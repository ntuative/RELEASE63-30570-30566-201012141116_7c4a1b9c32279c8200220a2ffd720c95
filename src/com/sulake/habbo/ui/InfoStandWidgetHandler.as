   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_141,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_125,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_154,this.onFigureUpdate);
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_152,this.onPetInfo);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_141,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_125,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_154,this.onFigureUpdate);
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_152,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_626.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_626.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_338);
         _loc1_.push(RoomWidgetUserActionMessage.const_809);
         _loc1_.push(RoomWidgetUserActionMessage.const_712);
         _loc1_.push(RoomWidgetUserActionMessage.const_676);
         _loc1_.push(RoomWidgetUserActionMessage.const_651);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_727);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_282);
         _loc1_.push(RoomWidgetFurniActionMessage.const_638);
         _loc1_.push(RoomWidgetFurniActionMessage.const_692);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_613);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_581);
         _loc1_.push(RoomWidgetUserActionMessage.const_397);
         _loc1_.push(RoomWidgetUserActionMessage.const_710);
         _loc1_.push(RoomWidgetUserActionMessage.const_458);
         _loc1_.push(RoomWidgetUserActionMessage.const_1285);
         _loc1_.push(RoomWidgetPetCommandMessage.const_661);
         _loc1_.push(RoomWidgetPetCommandMessage.const_729);
         _loc1_.push(RoomWidgetUserActionMessage.const_536);
         _loc1_.push(RoomWidgetUserActionMessage.const_320);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_397)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_320 || param1.type == RoomWidgetUserActionMessage.const_536 || param1.type == RoomWidgetUserActionMessage.const_458)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_338:
            ...
            case RoomWidgetUserActionMessage.const_809:
               ...
               break;
            case RoomWidgetUserActionMessage.const_712:
            ...
            case RoomWidgetUserActionMessage.const_676:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_994,_loc3_.name);
               this._container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_651:
            ...
            case RoomWidgetUserActionMessage.const_762:
               ...
               break;
            case RoomWidgetUserActionMessage.const_727:
            ...
            case RoomWidgetFurniActionMessage.const_692:
               ...
               break;
            case RoomWidgetUserActionMessage.const_320:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_613:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_581:
               ...
               break;
            case RoomWidgetUserActionMessage.const_397:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_784);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_351);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1063);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1103);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_355)
               {
                  _loc12_ = "null";
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_229)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_688);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1383;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_957;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1101;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1458);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = this.var_626.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_48);
            this.var_626.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_688);
