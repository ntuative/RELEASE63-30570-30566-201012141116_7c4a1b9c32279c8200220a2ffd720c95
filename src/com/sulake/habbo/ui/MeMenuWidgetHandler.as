   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_576,this.onFigureUpdate);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_421,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_576,this.onFigureUpdate);
            this._container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_165,this.onCreditBalance);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_1057,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1074,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_421,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1247)
            {
               ...
               this.var_1577 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1577;
            }
         }
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_927,HabboToolbarIconEnum.MEMENU);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_818);
         _loc1_.push(RoomWidgetDanceMessage.const_611);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_567);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_629);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_778);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_627);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_777);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_781);
         _loc1_.push(RoomWidgetStopEffectMessage.const_619);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1437);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_914);
         _loc1_.push(RoomWidgetToolbarMessage.const_596);
         _loc1_.push(RoomWidgetToolbarMessage.const_736);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_327);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1373);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_915);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_620);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_682);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_635);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1511);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_593);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_574);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_597);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_382);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_682:
               ...
               break;
            case RoomWidgetWaveMessage.const_818:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_611:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_567:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_629:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_778:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_781:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_895)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_166,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_777:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1106:
                        this._catalog.openCatalogPage(CatalogPageName.const_1281,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_911:
            ...
            case RoomWidgetStopEffectMessage.const_619:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_986:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_914:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_620:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_596:
               ...
               if(this._toolbar)
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
                     if(this._container != null && this._container.sessionDataManager != null)
               ...
               break;
            case RoomWidgetToolbarMessage.const_736:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_465,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_327:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_471));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_635:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_323,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_593:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_323,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_574:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_323,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_597:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_542));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_382:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_693));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_575));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_421:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_446));
         }
      }
