package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_531:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_152.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_120,HabboWindowStyle.const_37,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1537,"/");
         if(_loc5_ != null)
         {
         ...
         {
            if(this.var_152.habboConfiguration.getKey("use.sso","false") == "true")
            {
               _loc8_.select();
            }
         }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1537,"/");
         ...
         {
            dispatchEvent(new Event(const_531));
         }
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         {
            this.var_151.removeEventListener(SSOTicket.const_348,this.onParsedTicketSuccess);
            this.var_151.removeEventListener(SSOTicket.const_260,this.onParsedTicketFailure);
            this.var_151 = null;
         }
         var _loc1_:String = "";
         if(this.var_152.habboConfiguration != null)
         {
            _loc1_ = this.var_152.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = this.var_152.habboCommunication.habboWebLogin(this.name,this.password);
         this.var_151 = new SSOTicket(this.var_152.assets,_loc2_,_loc1_);
         this.var_151.addEventListener(SSOTicket.const_348,this.onParsedTicketSuccess);
         this.var_151.addEventListener(SSOTicket.const_260,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_151.ticket);
         this.var_152.shockwaveClientUrl = this.var_151.shockwaveClientUrl;
         this.var_152.ssoTicket = this.var_151.ticket;
         this.var_151.removeEventListener(SSOTicket.const_348,this.onParsedTicketSuccess);
         this.var_151.removeEventListener(SSOTicket.const_260,this.onParsedTicketFailure);
         this.var_151 = null;
         dispatchEvent(new Event(const_531));
