package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_47:IHabboCommunicationManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_18:IRoomSessionManager;
      
      private var var_475:IKeyExchange;
      
      private var var_879:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2403:PseudoRandom;
      ...
      private var var_204:HabboHotelView;
      
      private var var_1337:String = "";
      
      private const const_1537:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_576 = param1;
            this.var_47.initConnection(HabboConnectionType.const_223);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_18.events.addEventListener(RoomSessionEvent.const_92,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_47 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_47.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_47.addHabboConnectionMessageEvent(new HelloMessageEvent(this.onHelloEvent));
            this.var_47.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_47.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_47.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_47.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_47.addHabboConnectionMessageEvent(new StartRegistrationEvent(this.onStartRegistration));
            this.var_47.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_47.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_47.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_47.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_47.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_47.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_47.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_47.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_47 && this.var_122 && this.var_18 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_204 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_122.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_122.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_204.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_122.getKey("use.sso.ticket") == "1";
         this.var_576 = this.var_122.getKey("sso.ticket",null);
         this.var_1716 = this.var_122.getKey("flash.client.url","");
         this.var_2401 = this.var_122.getKey("external.variables.txt","");
         if(this.var_204 == null)
         {
            this.var_204 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_47.mode = HabboConnectionType.const_115;
            if(this.var_576)
            {
               this.var_47.initConnection(HabboConnectionType.const_223);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_531,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_47.mode = HabboConnectionType.const_115;
            if(this.var_122.keyExists("local.environment"))
            {
               this.var_47.mode = HabboConnectionType.const_1082;
            }
         }
         this.var_47.initConnection(HabboConnectionType.const_223);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_47.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_758);
            _loc3_ = new InitCryptoMessageComposer(this.var_47.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2403 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_47.mode)
         {
            case HabboConnectionType.const_115:
               _loc6_ = "";
               _loc6_ = this.var_122.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_122.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1337 = _loc4_;
               this.var_204.loadBannerImage(_loc7_ + "?token=" + this.var_1337,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1082:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1310:
               this.var_879 = this.generateRandomHexString(30);
               this.var_475 = new DiffieHellman(new BigInteger(this.var_122.getKey("connection.development.prime"),16),new BigInteger(this.var_122.getKey("connection.development.generator"),16));
               this.var_475.init(this.var_879);
               _loc8_ = this.var_475.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_47.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_475.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_475.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2403);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1336 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_203);
         connection.send(new VersionCheckMessageComposer(401,this.var_1716,this.var_2401));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1537,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_576 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_576);
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_189);
         }
      ...
      {
         var _loc4_:IConnection = this.var_47.getHabboMainConnection(null);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_211);
      }
      ...
      private function onStartRegistration(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_212);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1336)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_184);
         }
         if(param1.type == Event.CLOSE && !this.var_2402)
         {
            _loc2_ = this.var_122.getKey("logout.disconnect.url");
            if(this.var_122.keyExists("facebook.user"))
            {
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2402 = true;
         var _loc2_:String = this.var_122.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_122.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1337);
         ...
         var _loc9_:IConnection = this.var_47.getHabboMainConnection(null);
         ...
         this.var_475 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_475.init(_loc14_);
            _loc15_ = this.var_475.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_879 = _loc14_;
            }
