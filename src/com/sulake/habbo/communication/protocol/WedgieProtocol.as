package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1284:uint = 1;
      
      public static const const_1341:uint = 2;
       
      
      private var var_1334:IProtocolEncoder;
      ...
      {
         super();
         this.var_1334 = new WedgieEncoder();
         this.var_1026 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1284)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1026.getID(_loc4_);
