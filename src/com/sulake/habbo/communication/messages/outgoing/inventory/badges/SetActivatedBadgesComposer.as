package com.sulake.habbo.communication.messages.outgoing.inventory.badges
{
   ...
   public class SetActivatedBadgesComposer implements IMessageComposer
   {
      ...
      {
         if(this.var_1131.length >= this.const_1582)
         {
            return;
         }
         this.var_1131.push(param1);
      }
      ...
      public function getMessageArray() : Array
      {
         ...
         var _loc2_:int = 1;
         while(_loc2_ <= this.const_1582)
         {
            if(_loc2_ <= this.var_1131.length)
            {
               _loc1_.push(_loc2_);
               _loc1_.push(this.var_1131[_loc2_ - 1]);
            }
            else
            {
               _loc1_.push(_loc2_);
