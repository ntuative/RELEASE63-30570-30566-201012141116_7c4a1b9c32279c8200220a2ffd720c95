package com.sulake.habbo.communication.messages.incoming.moderation
{
   ...
   public class RoomChatlogData
   {
      ...
      public function RoomChatlogData(param1:IMessageDataWrapper)
      {
         ...
         super();
         this.var_1516 = param1.readBoolean();
         ...
         while(_loc3_ < _loc2_)
         {
            this.var_1515.push(new ChatlineData(param1));
            _loc3_++;
         }
         Logger.log("READ ROOMCHATLOGDATA: " + this.var_1516 + ", " + this._roomId + ", " + this.var_849 + ", " + this.chatlog.length);
      }
