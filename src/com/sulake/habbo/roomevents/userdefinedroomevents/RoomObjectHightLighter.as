package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_87.roomEngine.getRoomObject(this.var_87.roomId,this.var_87.roomCategory,param1,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE);
      }
