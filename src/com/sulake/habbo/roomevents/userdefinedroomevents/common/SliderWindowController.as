package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_668:BitmapData;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1064,param1);
         this.var_851 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_851);
         }
      ...
      {
         return int(this.var_1567 * (Number(param1 - this._minValue) / (this.var_1064 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1567 * (this.var_1064 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_852)
         {
            if(param1.type == WindowMouseEvent.const_56 || param1.type == WindowMouseEvent.const_176)
            {
               this.var_852 = false;
            }
         }
         if(!this.var_852 || param1.type != WindowEvent.const_342)
         {
            return;
         }
         if(this.var_558 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_558) * this.var_558;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_558 != 0)
            {
               _loc3_ = this.var_851 + this.var_558;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_669 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_669.width,this.var_669.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_669,this.var_669.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_668 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_668.width,this.var_668.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_668,this.var_668.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1567 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_669 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_668 = BitmapData(_loc2_.content);
      }
   }
}
