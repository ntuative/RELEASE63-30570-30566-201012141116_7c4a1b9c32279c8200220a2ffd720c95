package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1538:TriggerConfs;
      
      private var var_1539:ActionTypes;
      
      private var var_1537:ConditionTypes;
      
      private var var_225:Dictionary;
      
      private var var_57:Triggerable;
      
      private var var_664:RoomObjectHightLighter;
      
      private var var_167:UserDefinedRoomEventsHelp;
      
      private var var_982:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1538 = new TriggerConfs();
         this.var_1539 = new ActionTypes();
         this.var_1537 = new ConditionTypes();
         this.var_225 = new Dictionary();
         super();
         this.var_87 = param1;
         this.var_664 = new RoomObjectHightLighter(param1);
         this.var_167 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_225[param1])
         {
            delete this.var_225[param1];
            this.var_664.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_57.furniLimit)
         {
            this.var_225[param1] = param2;
            this.var_664.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_982 = new SliderWindowController(this.var_87,IWindowContainer(this.find(this.var_88,"delay_slider_container")),this.var_87.assets,0,20,1);
         this.var_982.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_982.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_664.hideAll(this.var_225);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_982.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_167.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1538);
         this.refreshConfigureElement(this.var_1539);
         this.refreshConfigureElement(this.var_1537);
