package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_270:MainViewCtrl;
      
      private var var_546:RoomInfoViewCtrl;
      
      private var var_1023:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_370:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2678:Dictionary;
      ...
      private var var_2165:RoomThumbnailRenderer;
      
      private var var_859:GuestRoomPasswordInput;
      
      private var var_308:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_270 = new MainViewCtrl(this);
         this.var_546 = new RoomInfoViewCtrl(this);
         this.var_1023 = new RoomCreateViewCtrl(this);
         this.var_2165 = new RoomThumbnailRenderer(this);
         this.var_859 = new GuestRoomPasswordInput(this);
         this.var_308 = new GuestRoomDoorbell(this);
         this.var_370 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_273,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_546.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_114,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_114,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_270.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_270.startSearch(Tabs.const_208,Tabs.const_354,param1);
         this.var_270.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_270.startSearch(Tabs.const_261,Tabs.const_216);
         this.var_370.getTab(Tabs.const_261).tabPageDecorator.tabSelected();
      }
