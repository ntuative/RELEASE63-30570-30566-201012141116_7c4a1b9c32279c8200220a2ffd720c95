package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_554 = new Timer(100);
         this.var_554.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_37 = new Array();
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_47,104,"a"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_47,94,"b"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_47,36,"c"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_47,84,"d"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_47,80,"e"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_47,80,"f"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_47,416,"i"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_47,320,"j"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_47,448,"k"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_47,352,"l"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_47,384,"m"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_47,372,"n"));
      ...
      public function dispose() : void
      {
         if(this.var_554)
         {
            this.var_554.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_554.reset();
            this.var_554 = null;
         }
      }
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_1640 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1640 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_51 = IItemListWindow(this.var_160.findChildByName("item_list"));
         ...
         this.var_1054 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_160.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1054.goBackToInitialState();
         this.var_1054.input.textBackgroundColor = 4294967295;
         this.var_1053 = this.var_37[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_54,HabboWindowStyle.const_34,HabboWindowParam.const_57,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         var _loc1_:Boolean = this.var_1054.checkMandatory(this._navigator.getText("navigator.createroom.nameerr"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_1054.getText();
