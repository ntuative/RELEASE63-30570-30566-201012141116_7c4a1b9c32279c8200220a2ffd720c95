package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_1036:int = 4;
      
      private static const const_867:int = 1;
      
      private static const const_555:int = 2;
      
      private static const const_868:int = 3;
      
      private static const const_1222:int = 4;
      ...
      private var var_873:GuestRoomListCtrl;
      
      private var var_1086:OfficialRoomListCtrl;
      ...
      private var var_1088:Boolean = true;
      
      private var var_1325:int = 0;
      
      private var var_1324:IWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_873 = new GuestRoomListCtrl(this._navigator);
         this.var_1086 = new OfficialRoomListCtrl(this._navigator);
      ...
      private function prepare() : void
      {
         ...
         this.var_243 = ITabContextWindow(this.var_17.findChildByName("tab_context"));
         if(!this.var_243)
         {
         ...
         this.var_203 = IWindowContainer(this.var_17.findChildByName("custom_content"));
         this.var_182 = IWindowContainer(this.var_17.findChildByName("list_content"));
         this.var_237 = IWindowContainer(this.var_17.findChildByName("custom_footer"));
         this.var_1324 = this.var_17.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_17.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1087 = IRegionWindow(this.var_17.findChildByName("to_hotel_view"));
         if(!this.var_1087)
         {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1417,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_160,["custom_content","list_content"],this.var_203.y,8);
         this.var_182.height = this.var_182.height + _loc1_ - this.var_182.y - this.var_237.height + this.var_2384;
         Util.moveChildrenToColumn(this.var_160,["list_content","custom_footer"],this.var_182.y,0);
         this.var_2384 = this.var_237.height;
      ...
      private function refreshFooter() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(this.var_237);
      ...
      {
         this.refreshList(param1,param2,this.var_873,"guest_rooms");
      }
      ...
      {
         this.refreshList(param1,param2,this.var_1086,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_573 == const_867)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_182.blend - _loc2_));
            this.var_182.blend = _loc3_;
            this.var_203.blend = !!this.var_1088 ? Number(_loc3_) : Number(1);
            this.var_237.blend = !!this.var_1088 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_573 = const_555;
            }
         }
         else if(this.var_573 == const_555)
         {
            if(this.var_1325 % 10 == 1)
            {
               this.var_1324.visible = !this.var_1324.visible;
            }
            ++this.var_1325;
            if(!this._navigator.data.isLoading())
            {
               this.var_573 = const_868;
            }
         }
         else if(this.var_573 == const_868)
         {
            this.refresh();
            this.var_573 = const_1222;
         }
         else
         {
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.refreshScrollbar(this.var_873);
      }
