package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2669:IWindowContainer;
      
      private var var_435:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_435 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_435.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_435 == null ? 0 : int(this.var_435.selection);
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_764;
         }
         if(param1 == 2)
         {
            return Tabs.const_717;
         }
         if(param1 == 3)
         {
            return Tabs.const_767;
         }
         if(param1 == 4)
         {
