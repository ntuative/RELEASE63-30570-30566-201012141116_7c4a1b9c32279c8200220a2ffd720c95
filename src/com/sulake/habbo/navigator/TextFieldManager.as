package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         this.var_70.addEventListener(WindowKeyboardEvent.const_148,this.checkEnterPress);
         this.var_70.addEventListener(WindowEvent.const_104,this.checkMaxLen);
         this.var_2422 = this.var_70.textBackground;
         this._orgTextBackgroundColor = this.var_70.textBackgroundColor;
         this.var_2421 = this.var_70.textColor;
      }
      ...
      {
         this.var_70.textBackground = this.var_2422;
         this.var_70.textBackgroundColor = this._orgTextBackgroundColor;
         this.var_70.textColor = this.var_2421;
      }
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_70.text = this.var_1309;
            this.var_580 = true;
         }
         else
         {
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_70.text = this.var_2423;
         this.var_580 = false;
         this.restoreBackground();
      }
      ...
      private function checkMaxLen(param1:Event) : void
      {
         ...
         {
            this.var_70.text = _loc2_.substring(0,this.var_1724);
         }
      }
   }
}
