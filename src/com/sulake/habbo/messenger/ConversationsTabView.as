package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         ...
         this.var_866 = IWindowContainer(param2.findChildByName("conversationstab"));
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_160.findChildByName("convo_bg"));
         _loc3_.bitmap = this.var_121.getButtonImage("convo_bg");
      }
      
      public function getTabCount() : int
      {
         return Math.floor(this.var_866.width / this.var_1083);
      }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:Array = this.var_121.conversations.openConversations;
         var _loc2_:int = 0;
         while(_loc2_ < this.getTabCount())
         {
            this.refreshTabContent(_loc2_,_loc1_[this.var_121.conversations.startIndex + _loc2_]);
            _loc2_++;
         }
         while(true)
         {
      ...
      {
         var _loc3_:IWindowContainer = this.var_866.getChildAt(param1) as IWindowContainer;
         if(_loc3_ == null)
         {
            if(param2 == null)
            {
            ...
            _loc3_ = IWindowContainer(this.var_121.getXmlWindow("tab_entry"));
            _loc3_.y = 1;
         ...
         _loc3_.x = param1 * this.var_1083;
         _loc3_.width = this.var_1083;
         return false;
      }
      ...
      private function refreshAsArrow(param1:int, param2:Boolean) : void
      {
         ...
         var _loc4_:int = this.var_866.width % this.var_1083;
         _loc3_.width = this.var_1083 + (!!param2 ? _loc4_ : 0);
      }
      
      private function refreshTabBg(param1:IWindowContainer, param2:int, param3:String) : void
      {
         this.var_121.refreshButton(param1,param3,true,this.onTabClick,param2);
      }
      ...
      private function refreshFigure(param1:IWindowContainer, param2:String) : void
      {
         ...
         {
            _loc3_.bitmap = this.var_121.getAvatarFaceBitmap(param2);
            _loc3_.visible = true;
         }
      }
      ...
      {
         this.var_121.refreshButton(param1,!!param3 ? "next" : "prev",true,null,0);
      }
      
      private function hasPrevButton() : Boolean
      {
         return this.var_121.conversations.startIndex > 0;
      }
      
      private function hasNextButton() : Boolean
      {
         return this.var_121.conversations.openConversations.length - this.var_121.conversations.startIndex > this.getTabCount();
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this.var_121.conversations.changeStartIndex(-1);
         }
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_156 ? this.var_121.conversations.findConversation(param2.id) : this.var_121.conversations.openConversations[_loc3_ + this.var_121.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
            this.var_121.conversations.setSelected(_loc4_);
         }
