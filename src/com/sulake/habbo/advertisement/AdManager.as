package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1136:BitmapData = null;
      
      private var var_1137:BitmapData = null;
      ...
      {
         this.var_284 = param2 as IHabboCommunicationManager;
         if(this.var_284 == null)
         {
            return;
         }
         this._connection = this.var_284.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2552 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2553 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2551 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1814 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_208 != null && this.var_208.running)
         {
            this.var_208.reset();
            return false;
         }
         if(this.var_1135 == 0)
         {
            this.var_1135 = getTimer();
            return false;
         }
         if(this.var_1814 > 0 && this.var_1815 >= this.var_1814)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1135;
         if(_loc1_ > this.var_2553)
         {
            ++this.var_1815;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1390 = _loc2_.imageUrl;
         this.var_2554 = _loc2_.clickUrl;
         this.var_1135 = getTimer();
         if(this.var_1390 != "")
         {
            ...
            {
               this.var_208 = new Timer(this.var_2551,1);
               this.var_208.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_208.running)
            {
               this.var_208.reset();
            }
            this.var_208.start();
            _loc4_ = new URLRequest(this.var_1390);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_400,0,0,param1.bitmapData,this.var_2554));
            this.var_1135 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_396));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1813 = _loc2_.clickUrl;
         if(this.var_1391 != "" && this.var_1813 != "")
         {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_493,0,0,_loc4_,this.var_1813,this.var_1136,this.var_1137));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1136 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1137 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
