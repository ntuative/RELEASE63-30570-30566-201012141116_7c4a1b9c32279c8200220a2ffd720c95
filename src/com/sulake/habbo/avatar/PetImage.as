package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_232:AvatarImageCache;
      ...
      private var var_509:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_43)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1242);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_586);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc16_ = this.var_1242 < 3;
               _loc17_ = !!_loc16_ ? 32 : 67;
               if(this._scale == AvatarScaleType.const_80)
               {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_586);
                  _loc20_ = this.var_85;
                  _loc21_ = 1;
                  switch(this.var_85)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_586);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_586);
                  _loc21_ = this.var_85;
                  _loc22_ = 1;
                  switch(this.var_85)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_479 = this.var_479 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_337:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1438:
                  case AvatarAction.const_1477:
                  case AvatarAction.const_1479:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_806);
         this.getCache().resetBodyPartCache(this.var_806);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1241 = this._structure.sortActions(this.var_287);
         ...
         {
            this.var_678 = this._structure.getCanvasOffsets(this.var_1241,this._scale,this.var_85);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1241)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_336)
               {
                  this.var_807 = true;
               }
               ...
               if(_loc1_.actionType == AvatarAction.const_281)
               {
                  this.var_807 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1240 = _loc4_.id;
                     this.var_1553 = _loc4_.breed;
                     break;
                  }
               }
            }
