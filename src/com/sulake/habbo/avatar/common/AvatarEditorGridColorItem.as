package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_809:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_666.width,this.var_666.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_666,this.var_666.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_986.width,this.var_986.height,true,0);
            _loc5_ = this.var_986.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_809.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_808.width,this.var_808.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_808,this.var_808.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_809)
            {
               switch(this.var_809.clubLevel)
               {
                  case HabboClubLevelEnum.const_47:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_60:
                     _loc4_.style = HabboIconType.const_747;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_51:
                     _loc4_.style = HabboIconType.const_820;
                     _loc4_.visible = true;
               }
            }
            else
