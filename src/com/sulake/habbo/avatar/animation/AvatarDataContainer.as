package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2530:uint;
      
      private var var_2531:uint;
      
      private var var_1733:ColorTransform;
      
      private var _rgb:uint;
      
      private var var_1835:uint;
      ...
      private var var_1833:Number = 1.0;
      
      private var var_1832:Number = 1.0;
      ...
      {
         super();
         this.var_1809 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2530 = parseInt(_loc2_,16);
         this.var_2531 = parseInt(_loc3_,16);
         this._rgb = parseInt(_loc2_,16);
         this.var_1835 = this._rgb >> 16 & 255;
         this.var_1834 = this._rgb >> 8 & 255;
         this._b = this._rgb >> 0 & 255;
         this.var_1836 = this.var_1835 / 255 * 1;
         this.var_1833 = this.var_1834 / 255 * 1;
         this.var_1832 = this._b / 255 * 1;
         if(this.var_1809 == 37)
         {
            this._alphaMultiplier = 0.5;
            this.var_2529 = false;
         }
         this.var_1733 = new ColorTransform(this.var_1836,this.var_1833,this.var_1832,this._alphaMultiplier);
         this.var_1133 = this.generatePaletteMapForGrayscale(this.var_2531,this.var_2530);
      }
      ...
      {
         return this.var_1133.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1133.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1133.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1133.getValue("alphas") as Array;
      }
