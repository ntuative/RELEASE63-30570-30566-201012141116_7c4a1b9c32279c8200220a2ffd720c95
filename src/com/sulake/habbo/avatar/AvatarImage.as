package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1162:String = "Default";
      
      private static const const_1161:int = 2;
      
      private static const const_1163:String = AvatarSetType.const_32;
      ...
      protected var var_232:AvatarImageCache;
      
      protected var var_614:AvatarFigureContainer;
      
      protected var var_509:IAvatarDataContainer;
      
      protected var var_287:Array;
      
      protected var var_39:BitmapData;
      
      private var var_806:IActiveActionData;
      ...
      protected var var_1169:Boolean = false;
      ...
      private var var_2439:String = null;
      
      private var var_2440:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_614 = param3;
         this.var_232 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1163,const_1161);
         this.var_287 = new Array();
         this.var_806 = new ActiveActionData(AvatarAction.const_339);
         this.var_806.definition = this._structure.getActionDefinition(const_1162);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_700)
         {
            ...
            if(this.var_711)
            {
               for each(_loc2_ in this.var_711)
               {
                  _loc2_.dispose();
               }
      ...
      {
         param2 += this.var_1554;
         if(param2 < AvatarDirectionAngle.const_1040)
         {
            param2 = AvatarDirectionAngle.const_303 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_303)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_586,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_276.length == 1 && this.var_85 == this.var_1878)
         {
            return this.var_85 + this.var_479 + this.var_586 % 4;
         }
         if(this.var_276.length == 2)
         {
            for each(_loc1_ in this.var_276)
            {
               ...
               {
                  return this.var_85 + this.var_479 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_586 % 11;
                  return this.var_85 + "_" + this.var_1878 + this.var_479 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2441 || param2 != this.var_2439 || param1 != this.var_2440)
         {
            this.var_2441 = param3;
            this.var_2439 = param2;
            this.var_2440 = param1;
            this.var_1740 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1169 || this.var_39 == null || (this.var_39.width != _loc5_.width || this.var_39.height != _loc5_.height))
         {
            if(this.var_39 != null && !this.var_1169)
            {
               this.var_39.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_254.definition.geometryType,this.var_85);
         this.var_39.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_586);
         ...
         {
            if(this.var_509.paletteIsGrayscale)
            {
               ...
               this.var_39 = _loc13_;
               this.var_39.paletteMap(this.var_39,this.var_39.rect,new Point(0,0),this.var_509.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_254.definition.geometryType,this.var_85);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_586);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_287.push(new ActiveActionData(param1,param2,this.var_586));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_254 = this.var_806;
         this.var_254.definition = this.var_806.definition;
         this.resetBodyPartCache(this.var_806);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_276)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_479 = "";
         this.var_276 = this._structure.sortActions(this.var_287);
         if(this.var_276 == null)
         {
         ...
         {
            this.var_678 = this._structure.getCanvasOffsets(this.var_276,this._scale,this.var_85);
            for each(_loc4_ in this.var_276)
            {
               this.var_479 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_284)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1361 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1361 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1362 != this.var_479)
            {
               _loc1_ = true;
               this.var_1362 = this.var_479;
            }
         }
         this.var_1239 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_276)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_807 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_177 = this.var_177.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1554 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_509 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_281 || _loc1_.actionType == AvatarAction.const_251 || _loc1_.actionType == AvatarAction.const_336)
               {
                  this.var_807 = true;
               }
            }
