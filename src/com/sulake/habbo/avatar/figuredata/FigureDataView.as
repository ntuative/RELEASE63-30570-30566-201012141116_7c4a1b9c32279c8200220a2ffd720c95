package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            this.var_1062 = _loc4_.content as BitmapData;
         }
         if(this._window != null)
         {
            this.var_367 = this._window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      
      public function udpate(param1:BitmapData) : void
      {
         if(this.var_367 && this.var_1062)
         {
            this.var_367.bitmap = new BitmapData(this.var_367.width,this.var_367.height,true,16777215);
            this.var_367.bitmap.copyPixels(this.var_1062,this.var_1062.rect,new Point(0,this.var_367.height - this.var_1062.height - 8));
            this.var_367.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
