package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_367:String = "pets";
      
      private static const const_1216:int = 100;
      ...
      private var var_871:IWindowContainer;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_253,this.onObjectPlaced);
         this._catalog = param7;
         this.var_572 = new Timer(const_1216,1);
         this.var_572.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2383 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_253,this.onObjectPlaced);
               }
            ...
            {
               this.var_572.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_572.stop();
               this.var_572 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_370)
         {
         ...
         else if(param3 == FurniCategory.const_353)
         {
         ...
         if(this.var_871 == null)
         {
            this.var_871 = this._windowManager.buildFromXML(this.var_2383) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_871.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_40,const_45];
         var _loc5_:int = 0;
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_376);
      ...
      public function updateLocks() : void
      {
         ...
         var _loc7_:Array = [const_40,const_45];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_40,const_45];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_470.add(const_40,new Array());
         this.var_470.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_305;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_370 || _loc3_.category == FurniCategory.const_358 || _loc3_.category == FurniCategory.const_353)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1321 && param1.type == RoomEngineObjectEvent.const_253)
         {
            this.var_1321 = false;
         }
      }
      ...
      {
         return this.var_470.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_305:
               ...
               break;
            case InventorySubCategory.const_924:
               this.removeAllLocks();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_470.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_470.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_766)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
