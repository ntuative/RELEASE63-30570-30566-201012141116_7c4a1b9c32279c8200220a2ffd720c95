package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1855:int = 0;
      
      private const const_881:int = 1;
      
      private const const_1548:int = 2;
      
      private const const_1546:int = 3;
      
      private const const_1549:int = 42;
      
      private const const_1547:int = 120;
      ...
      private var var_623:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_424.add(FurniModel.const_40,new FurniGridView(this.var_62,FurniModel.const_40,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_424.add(FurniModel.const_45,new FurniGridView(this.var_62,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_424.getValue(this.var_351);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_62.getCategoryContent(this.var_351);
         ...
         if(this.var_1972 == _loc2_)
         {
            return;
         }
         this.var_1972 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_424.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_424.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_424.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_62.getGroupItemInIndex(_loc3_,this.var_351);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_370)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_353)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_623 && this.var_623.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1547)
         {
            _loc3_ = this.const_1547;
         }
         else if(_loc3_ < this.const_1549)
         {
            _loc3_ = this.const_1549;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_58)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_367);
            }
         }
      }
   }
