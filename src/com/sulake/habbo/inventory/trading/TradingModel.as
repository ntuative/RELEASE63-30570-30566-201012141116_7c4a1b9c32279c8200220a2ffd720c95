package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1397:uint = 9;
      
      public static const const_180:uint = 0;
      
      public static const const_174:uint = 1;
      
      public static const const_380:uint = 2;
      
      public static const const_297:uint = 3;
      
      public static const const_464:uint = 4;
      
      public static const const_238:uint = 5;
      ...
      private var var_705:Boolean = false;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_48.updateItemList(this.var_706);
         this.var_48.updateItemList(this.var_1350);
      ...
      public function close() : void
      {
         if(this.var_691)
         {
            if(this._state != const_180 && this._state != const_238)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_180;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_924);
            this.var_691 = false;
         }
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_705 + " OTHER: " + this.var_1103);
         ...
         {
            case const_180:
               if(param1 == const_174 || param1 == const_238)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(this.var_274 == null || this.var_274.disposed)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         while(_loc4_ < this.var_274.length)
         {
            _loc2_ = this.var_274.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_48.alertPopup(TradingView.const_1110);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_706)
            {
               this.var_705 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1103 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_48.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_706)
            {
               this.var_48.alertPopup(TradingView.const_1065);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_274.length < const_1397)
         {
         ...
         else
         {
            ...
            if(this.var_274.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
