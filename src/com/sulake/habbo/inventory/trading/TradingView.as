package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_852:uint = 4284532064;
      
      private static const const_853:uint = 2577770;
      
      public static const const_1079:int = 0;
      ...
      private var var_372:ItemPopupCtrl;
      ...
      private var var_1622:IWindowContainer;
      
      private var var_176:Timer;
      
      private var var_801:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_372 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_176)
            {
               this.var_176.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_176.stop();
               this.var_176 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1622 = this.createMinimizedWindow();
         }
         if(!this.var_2296)
         {
            return this.var_64;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_64)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_852) : uint(const_853);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_852) : uint(const_853);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_176 = new Timer(1000,3);
            this.var_176.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_176.reset();
         this.var_176.repeatCount = 3;
         this.var_176.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_176.currentCount));
         if(this.var_176.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1006)
            {
            ...
            this.var_372.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_492);
            this.var_372.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_372.hideDelayed();
         }
      }
