package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      private var var_1009:Dictionary;
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_366 = new Timer(1000,1);
         this.var_366.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_355.events.addEventListener(BadgeImageReadyEvent.const_125,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_366)
            {
               this.var_366.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_366.reset();
               this.var_366 = null;
            }
            this._disposed = true;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_366.running);
         this.var_1009[param1.badgeId] = param1.badgeImage;
         if(!this.var_366.running)
         {
            this.var_366.start();
         }
      }
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1009[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_355.getBadgeImage(param2.badgeId);
            this.var_1009[param2.badgeId] = _loc4_;
         }
