package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1823:int = 5;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_791.length)
         {
            if(this.var_791[_loc2_] == param1)
            {
               this.var_791.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_355.getBadgeImage(param1);
            this.var_222.push(_loc8_);
            if(param2)
            {
      ...
      public function setBadgeSelected(param1:String) : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_222.length)
         {
            _loc2_ = this.var_222[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < this.var_222.length)
               {
                  if((this.var_222[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(this.var_222[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      {
         if(param1 == InventoryCategory.const_272 && this._controller.isVisible)
         {
