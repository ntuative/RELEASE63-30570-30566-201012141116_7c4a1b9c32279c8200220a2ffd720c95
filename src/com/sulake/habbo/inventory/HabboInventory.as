package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_936:IRoomSession;
      ...
      private const const_1828:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_45)
         {
            _loc1_ = this.var_45.getKeys();
            _loc2_ = 0;
            while(_loc2_ < _loc1_.length)
            {
               _loc3_ = _loc1_[_loc2_];
               _loc4_ = this.var_45.getValue(_loc3_) as IInventoryModel;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_18 != null)
         {
            this.var_18.events.removeEventListener(RoomSessionEvent.const_86,this.roomSessionEventHandler);
            this.var_18.events.removeEventListener(RoomSessionEvent.const_92,this.roomSessionEventHandler);
            this.var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_543,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_45.getValue(InventoryCategory.const_79));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_45.getValue(InventorySubCategory.const_305));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_45.getValue(InventoryCategory.const_660));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_45.getValue(InventoryCategory.const_272));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_45.getValue(InventoryCategory.const_334));
      }
      
      public function get recyclerModel() : RecyclerModel
      {
         return RecyclerModel(this.var_45.getValue(InventorySubCategory.RECYCLER));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(this.var_45.getValue(InventoryCategory.const_153));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_45.getValue(InventoryCategory.const_376) as MarketplaceModel;
      }
      ...
      {
         return this.var_101.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_101.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_101.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_101.clubHasEverBeenMember;
      }
      ...
      {
         this.var_101.clubPeriods = param1;
         this.var_101.clubDays = param2;
         this.var_101.clubHasEverBeenMember = param3;
         this.var_101.isVIP = param4;
      ...
      {
         this.var_355 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_18.events.addEventListener(RoomSessionEvent.const_86,this.roomSessionEventHandler);
         this.var_18.events.addEventListener(RoomSessionEvent.const_92,this.roomSessionEventHandler);
         this.var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_543,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               this.var_936 = param1.session;
               this._view.setHabboToolbarIcon();
               this.petsModel.method_4();
               this.furniModel.updateView();
               break;
            case RoomSessionEvent.const_92:
               this.var_936 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_543:
               this.petsModel.method_4();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_355 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_18 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_45.add(InventoryCategory.const_376,_loc1_);
         ...
         this.var_45.add(InventoryCategory.const_79,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_355);
         this.var_45.add(InventoryCategory.const_272,_loc3_);
         ...
         this.var_45.add(InventoryCategory.const_660,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_355);
         this.var_45.add(InventoryCategory.const_334,_loc5_);
         ...
         this.var_45.add(InventorySubCategory.const_305,_loc6_);
         ...
         this.var_45.add(InventorySubCategory.RECYCLER,_loc7_);
         ...
         this.var_45.add(InventoryCategory.const_153,_loc8_);
         this.var_172 = true;
         if(this.var_2218)
         {
            this.requestData();
      ...
      {
         var _loc2_:IInventoryModel = IInventoryModel(this.var_45.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_45.length)
         {
            _loc3_ = this.var_45.getWithIndex(_loc2_) as IInventoryModel;
            _loc3_.subCategorySwitch(param1);
            _loc2_++;
         }
         switch(param1)
         {
            case InventorySubCategory.const_305:
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = this.var_45.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_818.indexOf(param1) == -1)
            {
               this.var_818.push(param1);
            }
         }
         else
         {
            _loc3_ = this.var_818.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_818.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_818.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         var _loc2_:IInventoryModel = this.var_45.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1828);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_1057));
      }
