package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_759:int = 0;
      
      protected var var_620:BitmapData;
      ...
      protected var var_2610:BitmapData;
      
      private const const_1821:int = 8947848;
      
      private const const_1822:int = 13421772;
      
      private const const_1562:Number = 1;
      
      private const const_1561:Number = 0.2;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1354));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1866);
         }
         if(_loc1_.id > 0)
         {
            this.setLoadingImage(_loc1_.data);
            this.var_759 = _loc1_.id;
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1561;
               _loc1_.blend = this.const_1561;
            }
            else
            {
               this._window.blend = this.const_1562;
               _loc1_.blend = this.const_1562;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1872 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2610;
               _loc5_.visible = true;
            }
            else
            {
