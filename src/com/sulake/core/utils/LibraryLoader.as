package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1530:uint = 1;
      
      protected static const const_1528:uint = 2;
      
      protected static const const_1531:uint = 4;
      
      protected static const const_1529:uint = 3;
      
      protected static const name_2:uint = 7;
      
      public static const const_1409:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1051:Boolean = false;
      
      public static const const_1366:int = 2;
      
      private static var var_889:Array = new Array();
      
      private static var var_709:Array = new Array();
      ...
      protected var var_216:URLRequest;
      
      protected var var_649:XML;
      
      protected var var_524:Class;
      
      protected var var_412:uint = 0;
      
      protected var _name:String;
      
      protected var var_932:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_931:Boolean = false;
      
      protected var var_2614:String = "";
      
      protected var var_2615:String = "";
      
      protected var var_1877:int;
      
      protected var var_1167:int;
      
      protected var var_1168:int;
      
      protected var var_2689:uint = 0;
      
      protected var var_2616:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_36.load(param1.var_216,param1.var_16);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1051)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_709[_loc2_] as LibraryLoader;
            ...
            while(var_709.length < const_1366 && false)
            {
               _loc1_ = var_889.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_709.push(_loc1_);
                  _loc1_.var_36.load(_loc1_.var_216,_loc1_.var_16);
               }
            }
         }
      }
      ...
      {
         return !!this.var_216 ? this.var_216.url : null;
      }
      ...
      {
         return !!this.var_932 ? uint(this.var_1167 - this.var_1877) : uint(getTimer() - this.var_1877);
      }
      ...
      public function load(param1:URLRequest, param2:int = 5) : void
      {
         ...
         this._name = parseNameFromUrl(this.var_216.url);
      ...
      {
         if(this.var_931 && !_disposed)
         {
            this.var_931 = false;
            if(!this.var_932 && this.var_216)
            {
               this.var_1167 = -1;
               this.var_1877 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_932 && !_disposed && this.var_1168 > 0)
         {
            try
            {
               this.var_36.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_216,const_1409 - this.var_1168);
            if(this.var_2616)
            {
               this.var_216.requestHeaders.push(new URLRequestHeader("pragma","no-cache"));
               this.var_216.requestHeaders.push(new URLRequestHeader("Cache-Control","no-cache"));
               this.var_2616 = false;
            }
            --this.var_1168;
            this.var_412 = 0;
            this.var_36.load(this.var_216,this.var_16);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_412 == LibraryLoader.const_1529)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_524 = this.getDefinition(this._name) as Class;
         if(this.var_524 == null)
         {
            if(!this.retry())
            {
               this.failure("Failed to find resource class \"" + this._name + "\" from library " + this.var_216.url + "!");
            }
            return false;
         }
         try
         {
            xmlClass = this.var_524.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
         ...
         try
         {
            this.var_649 = new XML(bytes.readUTFBytes(bytes.length));
         }
         catch(e:Error)
         {
            if(!retry())
