package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1366:int = 4;
      ...
      {
         return this.var_361.length + this.var_255.length;
      }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(this.var_255.length < const_1366 && this.var_361.length > 0)
            {
               _loc1_ = this.var_361.shift();
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         try
         {
            index = this.var_361.indexOf(loader);
            if(index > -1)
            {
               this.var_361.splice(index,1);
            }
