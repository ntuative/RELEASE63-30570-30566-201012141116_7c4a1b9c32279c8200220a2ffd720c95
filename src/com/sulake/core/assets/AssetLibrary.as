package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1078:String = "AssetLibraryReady";
      
      public static const const_569:String = "AssetLibraryLoaded";
      
      public static const const_1372:String = "AssetLibraryUnloaded";
      
      public static const const_1400:String = "AssetLibraryLoadError";
      
      private static var var_262:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_430:uint = 0;
      
      private static var var_796:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_430;
         this.var_359 = new Dictionary(false);
         this.var_429 = new Dictionary(false);
         this.var_794 = new Dictionary(false);
         this.var_136 = new Dictionary(false);
         var_796.push(this);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_796.splice(var_796.indexOf(this),1);
            --var_430;
            this.var_429 = null;
            this.var_794 = null;
            this.var_136 = null;
      ...
      {
         if(this._file == param1.url && this.var_795)
         {
            if(!this.var_793 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_649,this.var_524);
            }
            this.var_793 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1078));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_429)
         {
            _loc2_ = this.var_429[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_429[_loc1_];
         }
         for(_loc1_ in this.var_136)
         {
            delete this.var_136[_loc1_];
         }
         for(_loc1_ in this.var_794)
         {
            delete this.var_794[_loc1_];
         }
         if(this.var_36 != null)
         {
            this.var_36.dispose();
         ...
         this.var_795 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1372));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_794[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_429[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_966,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_950,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_955,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1112,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_429[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_429[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_136[struct.assetName] == null)
                  {
                     ++this.var_358;
                     this.var_357.push(struct.assetName);
                  }
                  this.var_136[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_42,e.status);
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_429[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_136[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_357.length ? this.getAssetByName(this.var_357[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_136)
         {
            if(this.var_136[_loc2_] == param1)
            {
               return this.var_357.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_136[param1] != null || (this.var_524 != null ? this.var_524[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_136[param1] == null;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_136)
            {
               if(this.var_136[_loc2_] == param1)
               {
                  this.var_357.splice(this.var_357.indexOf(_loc2_),1);
                  delete this.var_136[_loc2_];
                  --this.var_358;
                  return param1;
               }
            }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_262.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_262[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_359.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_359[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_262[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         _loc3_ = AssetTypeDeclaration(this.var_359[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_262)
            {
               _loc3_ = AssetTypeDeclaration(var_262[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_359)
         {
            _loc3_ = AssetTypeDeclaration(this.var_359[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_262)
            {
               _loc4_ = AssetTypeDeclaration(var_262[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_359)
         {
            _loc4_ = AssetTypeDeclaration(this.var_359[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_649 = _loc2_.manifest.copy();
         this.var_524 = _loc2_.resource;
         ...
         this.var_795 = true;
         dispatchEvent(new Event(AssetLibrary.const_569));
         dispatchEvent(new Event(AssetLibrary.const_1078));
         if(this.var_793)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1400));
         this.var_36 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_649.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_524[param1]);
