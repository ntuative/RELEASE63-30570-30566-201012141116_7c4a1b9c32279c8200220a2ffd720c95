package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_512:uint = 0;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_112 is BitmapDataAsset)
         {
            ...
            this.var_1397 = BitmapDataAsset(this.var_112).var_1397;
            this.var_1398 = BitmapDataAsset(this.var_112).var_1398;
            if(this._bitmap != null)
            {
               this.var_112 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1397 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1398 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
