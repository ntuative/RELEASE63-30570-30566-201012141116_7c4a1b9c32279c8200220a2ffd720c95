package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_926 = param2 == null ? "" : param2.url;
         this._type = param1;
         ...
         {
            this.var_36.load(param2,this.var_925);
         }
      }
      ...
      {
         this.var_926 = param1.url;
         var_286 = 0;
         this.var_36.load(param1,this.var_925);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_286 < var_2609)
            {
               ...
               this.var_36.load(new URLRequest(this.var_926 + (this.var_926.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_286),this.var_925);
               return true;
            }
         }
         return false;
