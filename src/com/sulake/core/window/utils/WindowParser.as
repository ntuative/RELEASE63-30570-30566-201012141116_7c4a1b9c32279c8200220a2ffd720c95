package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1059:String = "_EXCLUDE";
      
      public static const const_1648:String = "_INCLUDE";
      
      public static const const_1671:String = "_TEMP";
      
      private static const const_1202:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      protected var var_1162:Dictionary;
      
      protected var var_930:Dictionary;
      
      protected var var_1412:Dictionary;
      
      protected var var_1875:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1162 = new Dictionary();
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1162);
         this.var_930 = new Dictionary();
         this.var_1412 = new Dictionary();
         ParamCodeTable.fillTables(this.var_930,this.var_1412);
         this.var_1875 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1201,"");
         return param1.replace(const_1202,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1162)
            {
               delete this.var_1162[_loc1_];
            }
            for(_loc1_ in this.var_930)
            {
               delete this.var_930[_loc1_];
            }
            for(_loc1_ in this.var_1412)
            {
               delete this.var_1412[_loc1_];
            }
            this.var_1875.dispose();
            this.var_1875 = null;
            this.var_16 = null;
            this._disposed = true;
         }
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_173)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1162[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1059) == -1)
                  {
