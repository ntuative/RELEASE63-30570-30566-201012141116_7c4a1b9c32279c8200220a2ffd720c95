package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_839:uint = 8;
      
      private static const const_1180:String = "skin";
      
      private static const const_1177:String = "bitmap";
      
      private static const const_1181:String = "fill";
      
      private static const const_1179:String = "text";
      
      private static const const_1178:String = "shape";
      
      private static const const_1175:String = "unknown";
      
      private static const const_1176:String = "null";
      ...
      private var var_821:Dictionary;
      ...
      private var var_2232:Dictionary;
      
      private var var_2233:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_821 = new Dictionary();
         this.var_822 = new Dictionary();
         this.var_1586 = new Dictionary();
         this.var_2232 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1586,this.var_2232);
         this.var_2233 = new Dictionary();
         this.var_2234 = new Dictionary();
         StateCodeTable.fillTables(this.var_2233,this.var_2234);
         this.var_450 = new Dictionary();
         this.var_450[const_1180] = BitmapSkinRenderer;
         this.var_450[const_1177] = BitmapDataRenderer;
         this.var_450[const_1181] = FillSkinRenderer;
         this.var_450[const_1179] = TextSkinRenderer;
         this.var_450[const_1178] = ShapeSkinRenderer;
         this.var_450[const_1175] = SkinRenderer;
         this.var_450[const_1176] = NullSkinRenderer;
         if(var_288 == null)
         {
            var_288 = new Array();
            var_288.push(WindowState.const_63);
            var_288.push(WindowState.const_75);
            var_288.push(WindowState.const_85);
            var_288.push(WindowState.const_46);
            var_288.push(WindowState.WINDOW_STATE_HOVERING);
            var_288.push(WindowState.const_77);
            var_288.push(WindowState.const_96);
            var_288.push(WindowState.const_89);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1586[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_821[param1] == null)
         {
            this.var_821[param1] = new Array(const_839);
         }
         this.var_821[param1][param2] = param3;
         if(this.var_822[param1] == null)
         {
            this.var_822[param1] = new Array(const_839);
         }
         this.var_822[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_821[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_299)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_822[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_299)
