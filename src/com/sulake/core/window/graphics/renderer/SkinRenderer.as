package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_508:Dictionary;
      
      protected var var_411:Dictionary;
      ...
      public function SkinRenderer(param1:String)
      {
         ...
         this.var_508 = new Dictionary();
         this.var_411 = new Dictionary();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_508)
            {
               ISkinLayout(this.var_508[_loc1_]).dispose();
               delete this.var_508[_loc1_];
            }
            this.var_508 = null;
            this.var_411 = null;
      ...
      {
         this.var_508[param1.name] = param1;
         return param1;
      }
      
      public function getLayoutByName(param1:String) : ISkinLayout
      {
         return this.var_508[param1];
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in this.var_411)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_411[_loc3_] == param1)
               {
                  this.removeLayoutFromRenderState(_loc3_);
               }
            }
            delete this.var_508[param1.name];
         }
         return param1;
      }
