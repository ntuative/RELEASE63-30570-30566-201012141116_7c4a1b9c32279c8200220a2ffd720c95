package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1720:Point;
      
      private var var_1339:Rectangle;
      
      private var var_273:Rectangle;
      
      private var var_840:ISkinContainer;
      
      private var var_324:Dictionary;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1720 = new Point();
         this.var_1339 = new Rectangle();
         this.var_273 = new Rectangle();
         this.var_324 = new Dictionary(true);
         this.var_840 = param1;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            this._disposed = true;
            this.var_701 = null;
            for(_loc1_ in this.var_324)
            {
               delete this.var_324[_loc1_];
            }
            this.var_324 = null;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_273.x = param2.x - param1.x;
            this.var_273.y = param2.y - param1.y;
            this.var_273.width = param2.width;
            this.var_273.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_31))
            {
               while(param1.testParamFlag(WindowParam.const_31))
               {
                  ...
                  this.var_273.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_273,WindowRedrawFlag.const_906);
            if(this.var_701.indexOf(param1) == -1)
            {
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            this.addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_73);
         }
      }
      
      protected function getWindowRendererItem(param1:IWindow) : WindowRendererItem
      {
         var _loc2_:WindowRendererItem = this.var_324[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_324[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_840);
            this.var_324[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_623,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_623,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_324[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_324[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_701.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_701.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_273.x = _loc3_.dirty.x;
               this.var_273.y = _loc3_.dirty.y;
               this.var_273.width = _loc3_.dirty.width;
               this.var_273.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_273,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1720,this.var_1339))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1720,this.var_1339))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_31))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1339);
