package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_562:uint = 1;
      
      public static const const_1092:uint = 2;
      
      public static const const_649:uint = 4;
      
      public static const const_1434:uint = 8;
      
      public static const const_1257:uint = 16;
      
      public static const const_1706:uint = 64;
      
      public static const const_1623:uint = 128;
      
      public static const const_1047:uint = 256;
      
      protected static var var_511:uint = 0;
      ...
      protected var var_763:Boolean;
      
      protected var _disposed:Boolean = false;
      
      protected var var_11:Rectangle;
      
      protected var var_173:Shape;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1092:
               ...
               break;
            case GraphicContext.const_1434:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1257:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_649:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1047:
               break;
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_173)
            {
               this.var_173 = new Shape();
               this.var_173.visible = false;
               this.var_173.cacheAsBitmap = true;
               super.addChild(this.var_173);
            }
            this.var_173.graphics.clear();
            this.var_173.graphics.beginFill(255);
            this.var_173.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_173.graphics.endFill();
            this.getDisplayObject().mask = this.var_173;
         }
         else if(this.var_173)
         {
            super.removeChild(this.var_173);
            this.var_173.graphics.clear();
            this.var_173 = null;
         ...
         if(this.var_763)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1879,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1879,16777215);
                  }
                  var_289 += bitmap.width * bitmap.height * 4;
               }
