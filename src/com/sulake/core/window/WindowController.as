package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1013:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1122:String = "_COLORIZE";
      
      protected static const const_1524:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1255:Point = new Point();
      ...
      protected var var_758:Function;
      
      protected var var_150:Boolean = true;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_306 = new Rectangle();
         if(_loc12_ != null)
         {
            var_345 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_56 = var_345.clone();
            var_11 = var_345.clone();
         ...
         if(_loc13_)
         {
            var_641 = _loc13_.blend;
            var_406 = _loc13_.treshold;
            if(var_405 != _loc13_.background)
            {
         ...
         if(param7 != null)
         {
            ...
            if(this.var_21)
            {
               var_16.invalidate(this,var_11,WindowRedrawFlag.const_73);
            }
         }
      }
      ...
      public static function resizeToAccommodateChildren(param1:WindowController, param2:Boolean = true) : void
      {
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  _loc12_ = param1.testParamFlag(WindowParam.const_87);
                  if(_loc12_)
                  {
      ...
      {
         return this.var_758 != null ? this.var_758 : (this.var_13 != null ? this.var_13.procedure : this.nullEventProc);
      }
      ...
      {
         var_405 = param1;
         var_213 = !!var_405 ? uint(var_213 | var_501) : uint(var_213 & 16777215);
         this.var_150 = this.var_150 || param1;
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_73);
      }
      ...
      {
         var_755 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_503,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_501 = param1 & 4278190080;
         var_213 = !!var_405 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_73);
      }
      ...
      {
         var_501 = param1 << 24;
         var_213 = !!var_405 ? uint(var_501 | var_213) : uint(16777215 & var_213);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_73);
      }
      
      public function set blend(param1:Number) : void
      {
         var_641 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_1105);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_477,this,null));
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_77 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_480,this,null));
         }
      }
      ...
      {
         var_406 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this.var_13 != param1)
         {
            ...
            if(this.var_13 != null)
            {
               this.var_306 = this.var_13.rectangle.clone();
               var_56.x = var_11.x;
               var_56.y = var_11.y;
               var_56.width = var_11.width;
               var_56.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_489,this,this.var_13));
            }
            else
            {
               this.var_306.x = 0;
               this.var_306.y = 0;
               this.var_306.width = 0;
               this.var_306.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1011,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_562,var_11);
            this.var_21.visible = var_346;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_77,var_19,var_16,var_11,null,this.var_758,this.properties,var_754.concat(),_id) as WindowController;
         _loc2_.var_406 = var_406;
         _loc2_.var_150 = this.var_150;
         _loc2_._debug = this._debug;
         _loc2_.var_306 = this.var_306.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_345 = var_345.clone();
         ...
         _loc2_.var_501 = var_501;
         _loc2_.var_755 = var_755;
         _loc2_.var_346 = var_346;
         _loc2_.var_641 = var_641;
         _loc2_.var_19 = var_19;
         _loc2_._state = _state;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_98;
         _loc2_.background = var_405;
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            if(true)
            {
               ...
               {
                  if(this.getStateFlag(WindowState.const_96))
                  {
                     this.deactivate();
                  }
               }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_16.invalidate(this,param1,WindowRedrawFlag.const_73);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            _loc7_ = uint(var_19 & 0);
            if(_loc7_ == WindowParam.const_460)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_533)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1096,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_753,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_511,this,null));
            }
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_181,this,null));
            }
         }
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_743))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_38:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_992;
                  if(testParamFlag(WindowParam.const_345))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_199))
                        {
               ...
               case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                  ...
                  break;
               case WindowMouseEvent.const_286:
                  return false;
            }
         }
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_181:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_173,WindowParam.const_144))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_163,WindowParam.const_150))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this.var_13 != null)
                     {
                        _loc9_ = uint(var_19);
                        var_19 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_401))
                        {
                           this.var_13.width += 0 - 0;
                        }
                        if(testParamFlag(WindowParam.const_434))
                        {
               ...
               case WindowNotifyEvent.const_511:
                  var_16.invalidate(this,var_11.union(var_56),WindowRedrawFlag.const_516);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_894,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_302,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_335:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_608,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_245,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_477:
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_980);
                  break;
               case WindowNotifyEvent.const_480:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1524) == -1)
                     {
                        _loc8_.style = var_77;
                     }
                  }
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_73);
                  break;
               case WindowNotifyEvent.const_503:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_21)
                     {
                        this.setupGraphicsContext();
                        var_16.invalidate(this,var_11,WindowRedrawFlag.const_516);
                     }
                  }
                  else if(var_19 & 0)
                  {
               ...
               case WindowNotifyEvent.const_395:
                  this.var_13.getRegionProperties(null,this.var_306);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_346:
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1081:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1316:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_1056:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_933:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_952:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1104:
               _loc2_ = "null";
               break;
         ...
         if(_loc2_ == WindowEvent.const_146)
         {
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_406);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_406);
      }
         ...
         if(this.var_150 && var_406 > 0)
         {
            if(!testParamFlag(WindowParam.const_31))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1255,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1255,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_126,WindowParam.const_144);
         var _loc2_:* = !testParamFlag(WindowParam.const_127,WindowParam.const_150);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this.var_13.width - this.var_306.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this.var_13.height - this.var_306.height;
               _loc5_ = uint(var_19 & 0);
               if(_loc5_ == WindowParam.const_369)
               {
      ...
      {
         if(_state == WindowState.const_538)
         {
            return true;
         }
         _state = WindowState.const_538;
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1046,this,null);
      ...
      public function minimize() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_63,true);
         _loc1_.type = WindowNotifyEvent.const_1095;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1056,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         this.setStateFlag(WindowState.const_63,true);
         _loc1_.type = WindowNotifyEvent.const_933;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function restore() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_63,false);
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_988,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         if(this.getStateFlag(WindowState.const_63))
         {
            return true;
         }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_996,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_756;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1104;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1077,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1256 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_346,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1256 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_600,this,param1));
         return param1;
      }
      ...
      protected function method_9() : Boolean
      {
         var _loc1_:* = null;
         if(testParamFlag(WindowParam.const_31))
         {
