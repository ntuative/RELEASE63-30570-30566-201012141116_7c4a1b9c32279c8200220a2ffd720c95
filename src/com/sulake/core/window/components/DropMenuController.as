package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_383:String = "_DROPMENU_TITLETEXT";
      
      protected static const const_1124:String = "_DROPMENU_ITEMLIST";
      
      protected static const const_1125:String = "item_array";
      ...
      private var var_169:DropMenuController;
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_534,this,null,true);
         this.update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_584 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_347,this,null));
         }
      }
      ...
      {
         if(this.var_169 != null && !this.var_169.disposed)
         {
            this.var_169.destroy();
            this.var_169 = null;
         }
         super.dispose();
      }
      ...
      {
         return getChildByName(DropMenuController.const_383) as ITextWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_169 == null || this.var_169.disposed)
         {
            this.var_169 = context.create(name + "::submenu","",WindowType.const_408,var_77,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_169.setGlobalRectangle(_loc1_);
         }
         this.var_169.activate();
         return this.var_169;
      }
      ...
      {
         var _loc2_:int = -1;
         var _loc3_:IItemListWindow = getChildByName(DropMenuController.const_1124) as IItemListWindow;
         if(_loc3_ != null)
         {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_169.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_888 = false;
            this.getTitleText().text = this.var_584 < this._itemArray.length && this.var_584 > -1 ? this._itemArray[this.var_584] : caption;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IItemListWindow = param2.getChildByName(DropMenuController.const_1124) as IItemListWindow;
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_444,var_77,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_378,var_77,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_584 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_584).setStateFlag(WindowState.const_46,true);
         }
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_978:
            case WindowMouseEvent.const_56:
               ...
               break;
            case WindowTouchEvent.const_783:
            case WindowMouseEvent.const_38:
               ...
               break;
            case WindowEvent.const_1098:
               if(param2 == this.var_169)
               {
                  this.closeMenuView();
               }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1125,this._itemArray,PropertyStruct.const_155,this._itemArray.length > 0));
         return _loc1_;
      }
