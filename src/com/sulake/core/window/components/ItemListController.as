package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected static const const_1120:String = "scale_to_fit_items";
      
      protected static const const_1118:String = "resize_on_item_update";
      
      protected static const const_1119:String = "auto_arrange_items";
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1523:Boolean = false;
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1522:Boolean = true;
       
      
      protected var var_618:Number;
      
      protected var var_617:Number;
      ...
      protected var var_1871:Boolean = false;
      ...
      protected var var_2660:Number = 0.0;
      
      protected var var_2661:Number = 0.0;
      
      protected var var_928:Boolean = true;
      
      protected var var_502:Boolean = false;
      
      protected var var_1159:Boolean = false;
      
      protected var var_1869:int = 0;
      
      protected var var_1870:int = 0;
      
      protected var var_1157:Number;
      
      protected var var_1156:Number;
      
      protected var var_1158:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_99 = 0;
         this.var_90 = 0;
         this._horizontal = param2 == WindowType.const_362;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_150 = var_405 || !testParamFlag(WindowParam.const_31);
         this._container = var_16.create("_CONTAINER","",WindowType.const_378,WindowStyle.const_707,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_270,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_451,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_1159;
      }
      ...
      {
         return new Rectangle(this.var_618 * this.maxScrollH,this.var_617 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_618)
         {
            this.var_618 = param1;
            this._container.x = -this.var_618 * this.maxScrollH;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_73);
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_617 = param1;
            this._container.y = -this.var_617 * this.maxScrollV;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_73);
            dispatchEvent(new WindowEvent(WindowEvent.const_472,this,null));
         }
      }
      ...
      {
         this.var_2660 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2661 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_401,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_434,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_270,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_451,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_38:
               this.var_1869 = _loc3_;
               this.var_1870 = _loc4_;
               this.var_1157 = 0;
               this.var_1156 = 0;
               this.var_1158 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_179:
               if(this.var_1158)
               {
                  this.var_1157 = this.var_1869 - _loc3_;
                  this.var_1156 = this.var_1870 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1157 != 0 && this.var_99 != 0)
                     {
                        this.scrollH += this.var_1157 / this.var_99;
                     }
                  }
                  else if(this.var_1156 != 0 && this.var_90 != 0)
                  {
                     this.scrollV += this.var_1156 / this.var_90;
                  }
                  this.var_1869 = _loc3_;
                  this.var_1870 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_176:
               if(this.var_1158)
               {
                  if(this._horizontal)
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1157,0);
                  }
                  else
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1156);
                  }
                  this.var_1158 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_928 && !this.var_503 && this._container)
         {
            this.var_503 = true;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1121,this._spacing,PropertyStruct.const_50,this._spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1119,this.var_928,PropertyStruct.const_53,this.var_928 != const_1522));
         _loc1_.push(new PropertyStruct(const_1120,this.var_502,PropertyStruct.const_53,this.var_502 != const_1523));
         _loc1_.push(new PropertyStruct(const_1118,this.var_1159,PropertyStruct.const_53,this.var_1159 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1118:
                  ...
                  break;
               case const_1119:
                  this.var_928 = _loc2_.value as Boolean;
                  break;
            }
         }
