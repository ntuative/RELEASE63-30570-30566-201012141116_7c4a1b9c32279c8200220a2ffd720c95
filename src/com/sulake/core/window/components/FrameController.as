package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1169:String = "_TITLE";
      
      private static const const_1190:String = "_HEADER";
      
      private static const const_1191:String = "_CONTENT";
      
      private static const const_1192:String = "_SCALER";
      
      private static const const_849:String = "margin_left";
      
      private static const const_847:String = "margin_top";
      
      private static const const_850:String = "margin_right";
      
      private static const const_848:String = "margin_bottom";
       
      
      private var _title:ITextWindow;
      
      private var var_1272:IHeaderWindow;
      
      private var var_160:IWindowContainer;
      
      private var var_79:IMargins;
      ...
      public function get title() : ITextWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1169) as ITextWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1272 = findChildByTag(const_1190) as IHeaderWindow;
            if(!this.var_1272)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_160 = findChildByTag(const_1191) as IWindowContainer;
            if(!this.var_160)
            {
      ...
      {
         return findChildByTag(const_1192) as IScalerWindow;
      }
      ...
      public function get margins() : IMargins
      {
         ...
         if(!this.var_79)
         {
            ...
            this.var_79 = new TextMargins(_loc1_.left,_loc1_.top,_loc1_.right,_loc1_.bottom,this.marginsCallback);
         }
         return this.var_79;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1122,_loc2_,false);
      ...
      {
         return this.content != null && this.var_932 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_293);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_228);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_255);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_228,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_228,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_307,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:* = this.var_79 != null;
         var _loc3_:Rectangle = this.content.rectangle;
         _loc1_.push(new PropertyStruct(const_849,_loc3_.left,PropertyStruct.const_50,_loc2_));
         _loc1_.push(new PropertyStruct(const_847,_loc3_.top,PropertyStruct.const_50,_loc2_));
         _loc1_.push(new PropertyStruct(const_850,0 - _loc3_.right,PropertyStruct.const_50,_loc2_));
         _loc1_.push(new PropertyStruct(const_848,0 - _loc3_.bottom,PropertyStruct.const_50,_loc2_));
         return _loc1_;
      }
