package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1193:String = "_SELECTOR";
      
      private static const const_1194:String = "_CONTENT";
       
      
      protected var var_929:ITabSelectorWindow;
      
      protected var var_1873:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_929 = findChildByTag(const_1193) as ITabSelectorWindow;
            if(this.var_929 != null)
            {
               this.var_929.procedure = this.selectorEventProc;
            }
         }
         return this.var_929;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1873 = findChildByTag(const_1194) as IWindowContainer;
         }
      ...
      {
         return !!this.var_677 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_929.numSelectables;
      }
