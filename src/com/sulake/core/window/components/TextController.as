package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1123:Dictionary = createPropertySetterTable();
      
      protected static const ZERO_RECT:Rectangle = new Rectangle();
      
      protected static const const_1527:Array = [AntiAliasType.ADVANCED,AntiAliasType.NORMAL];
      
      protected static const const_1525:Array = [GridFitType.PIXEL,GridFitType.NONE,GridFitType.SUBPIXEL];
      
      protected static const const_1526:Array = [TextFieldAutoSize.NONE,TextFieldAutoSize.LEFT,TextFieldAutoSize.RIGHT,TextFieldAutoSize.CENTER];
      ...
      protected var var_79:TextMargins;
      ...
      private var var_377:String = "regular";
      
      private var var_201:TextStyle;
      ...
      {
         this.var_201 = new TextStyle();
         this.var_79 = new TextMargins(0,0,0,0,this.setTextMargins);
         this.var_507 = false;
         this.var_760 = 0;
         this.var_505 = 0;
         if(this._field == null)
         ...
         setTextFormatting(this._field,this.var_377,this.var_201);
      ...
      private static function setAntiAliasType(param1:TextController, param2:String) : void
      {
         ...
         param1.var_201.antiAliasType = param2;
      ...
      private static function setBold(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.var_201.fontWeight = TextStyle.BOLD;
      }
      ...
      private static function setFontFace(param1:TextController, param2:String) : void
      {
         ...
         param1.defaultTextFormat = _loc3_;
         param1.var_201.fontFamily = param2;
      }
      ...
      private static function setFontSize(param1:TextController, param2:uint) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_201.fontSize = param2;
      }
      ...
      private static function setHtmlText(param1:TextController, param2:String) : void
      {
         ...
         if(param1.var_506)
         {
            param1.context.removeLocalizationListener(param1.var_98,param1);
            param1.var_506 = false;
         }
         param1.var_98 = param2;
         if(param1.var_98.charAt(0) == "$" && param1.var_98.charAt(1) == "{")
         {
            param1.context.registerLocalizationListener(param1.var_98.slice(2,param1.var_98.indexOf("}")),param1);
            param1.var_506 = true;
         }
         else if(param1._field != null)
         {
            param1._field.htmlText = param1.var_98;
            param1.refreshTextImage();
         }
      }
      ...
      private static function setItalic(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_201.fontStyle = !!param2 ? "null" : TextStyle.NORMAL;
      }
      ...
      private static function setKerning(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.defaultTextFormat = _loc3_;
         param1.var_201.kerning = param2;
      }
      
      private static function setTextMarginMap(param1:TextController, param2:Map) : void
      {
         param1.var_79.dispose();
         param1.var_79 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      private static function setSpacing(param1:TextController, param2:Number) : void
      {
         ...
         param1.setTextFormat(_loc4_);
         param1.defaultTextFormat = _loc3_;
         param1.var_201.letterSpacing = param2;
      }
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_377 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_377,param1.var_201);
            param1.refreshTextImage();
         }
      }
      ...
      private static function setUnderline(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_201.textDecoration = !!param2 ? "null" : TextStyle.NONE;
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_350);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_1114 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_377);
      }
      ...
      {
         this.var_760 = param1;
         this._field.scrollH = this.var_760 * Number(this._field.maxScrollH);
         this.refreshTextImage();
      }
      
      public function set scrollV(param1:Number) : void
      {
         if(param1 > this.var_505)
         {
            this.var_505 = param1;
            this._field.scrollV = Math.max(this._field.scrollV,param1 * this._field.maxScrollV + 1);
            this.refreshTextImage();
         }
         else if(param1 < this.var_505)
         {
            this.var_505 = param1;
      ...
      {
         return new Rectangle(this.var_760 * this.maxScrollH,this.var_505 * this.maxScrollV,width,height);
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         if(this.var_506)
         {
            context.removeLocalizationListener(var_98,this);
            this.var_506 = false;
         }
         var_98 = param1;
         if(var_98.charAt(0) == "$" && var_98.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_98.slice(2,var_98.indexOf("}")),this);
            this.var_506 = true;
         }
         else if(this._field != null)
         {
            this._field.text = var_98;
            this.refreshTextImage();
         }
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_760 = this.var_760;
         _loc1_.var_505 = this.var_505;
         _loc1_.var_79 = this.var_79.clone(_loc1_.setTextMargins);
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!this.var_507)
         {
            if(param2.type == WindowNotifyEvent.const_181)
            {
               this.refreshTextImage();
            }
         }
      ...
      protected function refreshTextImage() : void
      {
         ...
         this.var_507 = true;
         var _loc1_:int = this.var_79.left + this.var_79.right;
         var _loc2_:int = this.var_79.top + this.var_79.bottom;
      ...
      {
         if(param1 != this.var_79)
         {
            this.var_79.dispose();
            this.var_79 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,this.setTextMargins);
         }
         this.refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:Object = TextStyleManager.getStyle(this.var_377);
         _loc1_.push(new PropertyStruct("font_face",this.defaultTextFormat.font,PropertyStruct.const_90,this.defaultTextFormat.font != _loc2_.fontFamily));
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_288,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(new PropertyStruct("text_color",this._field.textColor,PropertyStruct.const_164,this._field.textColor != _loc2_.color));
         _loc1_.push(new PropertyStruct("antialias_type",this._field.antiAliasType,PropertyStruct.const_90,this._field.antiAliasType != AntiAliasType.ADVANCED,const_1527));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",this._field.gridFitType,PropertyStruct.const_90,this._field.gridFitType != GridFitType.PIXEL,const_1525));
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_50,this._field.maxChars != 0));
         ...
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_90,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_219,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("text_style",this.var_377,PropertyStruct.const_90,this.var_377 != TextStyleManager.const_350,STYLE_SHEET_RANGE));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_219,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_53,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("margin_left",this.var_79.left,PropertyStruct.const_50,this.var_79.left != 0));
         _loc1_.push(new PropertyStruct("margin_top",this.var_79.top,PropertyStruct.const_50,this.var_79.top != 0));
         _loc1_.push(new PropertyStruct("margin_right",this.var_79.right,PropertyStruct.const_50,this.var_79.right != 0));
         _loc1_.push(new PropertyStruct("margin_bottom",this.var_79.bottom,PropertyStruct.const_50,this.var_79.bottom != 0));
         _loc1_.push(new PropertyStruct("auto_size",this.var_410,PropertyStruct.const_90,this.var_410 != TextFieldAutoSize.NONE,const_1526));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_219,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
