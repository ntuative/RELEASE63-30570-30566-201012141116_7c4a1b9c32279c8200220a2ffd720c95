package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_185:ISelectableWindow;
      
      protected var var_1880:Boolean = true;
      ...
      {
         if(param2.type == WindowNotifyEvent.const_245)
         {
      ...
      {
         return this.var_185 as ISelectableWindow;
      }
         ...
         if(param1 != null)
         {
            if(param1 != this.var_185)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_347,this,this.var_185));
               }
            }
         }
      }
