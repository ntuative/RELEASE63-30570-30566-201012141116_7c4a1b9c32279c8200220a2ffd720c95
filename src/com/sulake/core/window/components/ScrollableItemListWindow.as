package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1095:IItemListWindow;
      
      private var var_383:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_75))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_383)
         {
            this.var_383.removeEventListener(WindowEvent.const_292,this.scrollBarEventProc);
            this.var_383.removeEventListener(WindowEvent.const_248,this.scrollBarEventProc);
            this.var_383 = null;
         }
         if(this.var_1095)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1095)
         {
            this.var_1095 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_383)
         {
            this.var_383 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_383)
            {
               this.var_383.addEventListener(WindowEvent.const_292,this.scrollBarEventProc);
               this.var_383.addEventListener(WindowEvent.const_248,this.scrollBarEventProc);
            }
         }
         return this.var_383;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_248)
         {
            this.hideScrollBar();
         }
      }
