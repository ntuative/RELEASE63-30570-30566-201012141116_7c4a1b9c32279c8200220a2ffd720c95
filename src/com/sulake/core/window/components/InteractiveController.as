package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1128:String = "tool_tip_caption";
      ...
      protected var var_2620:uint = 0;
      
      protected var var_413:Array;
      
      protected var var_1414:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_413[0] = MouseCursorType.const_352;
         this.var_413[1] = MouseCursorType.const_34;
         this.var_413[2] = MouseCursorType.const_352;
         this.var_413[3] = MouseCursorType.const_352;
         this.var_413[4] = MouseCursorType.const_34;
         this.var_413[5] = MouseCursorType.const_34;
         this.var_413[6] = MouseCursorType.const_352;
         if(var_256 == null)
         {
            var_256 = new Array();
            var_256[0] = WindowState.const_96;
            var_256[1] = WindowState.const_77;
            var_256[2] = WindowState.WINDOW_STATE_HOVERING;
            var_256[3] = WindowState.const_63;
            var_256[4] = WindowState.const_46;
            var_256[5] = WindowState.const_85;
            var_256[6] = WindowState.const_75;
         }
      ...
      public static function processInteractiveWindowEvents(param1:IInteractiveWindow, param2:Event) : void
      {
         if(param1.toolTipCaption != const_822)
         {
            ...
            else if(param2.type != WindowMouseEvent.const_179)
            {
      ...
      {
         param2.push(new PropertyStruct(const_1128,param1.toolTipCaption,PropertyStruct.const_90,param1.toolTipCaption != const_822));
      ...
      {
         this.var_1163 = param1 == null ? const_822 : param1;
      }
