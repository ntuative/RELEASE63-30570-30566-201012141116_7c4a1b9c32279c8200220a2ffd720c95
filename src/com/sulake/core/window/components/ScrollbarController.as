package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1186:String = "increment";
      
      private static const const_1187:String = "decrement";
      
      private static const const_846:String = "slider_track";
      
      private static const const_551:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_619:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_150 = false;
         this.var_20 = param12;
         this._horizontal = param2 == WindowType.const_494;
      ...
      {
         if(this.var_20 != null && !this.var_20.disposed)
         {
            this.var_20.removeEventListener(WindowEvent.const_44,this.onScrollableResized);
            this.var_20.removeEventListener(WindowEvent.const_472,this.onScrollableScrolled);
         }
         this.var_20 = param1;
         if(this.var_20 != null && !this.var_20.disposed)
         {
            this.var_20.addEventListener(WindowEvent.const_44,this.onScrollableResized);
            this.var_20.addEventListener(WindowEvent.const_472,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:String = "";
         if(this.var_20 is IWindow)
         {
            _loc2_ = IWindow(this.var_20).name;
         }
         else if(this.var_829 != null)
         {
            _loc2_ = this.var_829;
         }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_829 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_846) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_551) as WindowController;
      }
      ...
      protected function setScrollPosition(param1:Number) : Boolean
      {
         ...
         if(this._horizontal)
         {
            _loc2_ = this.var_20.scrollH != this._offset;
            this.var_20.scrollH = this._offset;
         }
         else
         {
            _loc2_ = this.var_20.scrollV != this._offset;
            this.var_20.scrollV = this._offset;
         }
         return _loc2_;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_551:
               if(param2.type == WindowNotifyEvent.const_302)
               {
                  if(!this.var_1022)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowNotifyEvent.const_489)
         {
            if(this.var_20 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_286)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_619;
                  }
                  else
                  {
                     this.scrollV -= this.var_619;
                  }
               }
      ...
      private function updateLiftSizeAndPosition() : void
      {
         ...
         if(_loc3_ != null)
         {
            if(this._horizontal)
            {
               _loc1_ = Number(this.var_20.visibleRegion.width / this.var_20.scrollableRegion.width);
               if(_loc1_ > 1)
               {
                  _loc1_ = 1;
               }
               ...
               _loc3_.width = _loc4_;
               _loc3_.x = this.var_20.scrollH * (_loc2_.width - _loc4_);
            }
            else
            {
               _loc1_ = Number(this.var_20.visibleRegion.height / this.var_20.scrollableRegion.height);
               if(_loc1_ > 1)
               {
                  _loc1_ = 1;
               }
               ...
               _loc3_.y = this.var_20.scrollV * (_loc2_.height - _loc3_.height);
            }
         }
         if(_loc1_ == 1)
         {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_38 || param1.type == WindowTouchEvent.const_499)
         {
            if(param2.name == const_1186)
            {
               if(this.var_20)
               {
                  this.var_1022 = true;
                  if(this._horizontal)
                  {
                     this.scrollH += this.var_20.scrollStepH / this.var_20.maxScrollH;
                  }
                  else
                  {
                     this.scrollV += this.var_20.scrollStepV / this.var_20.maxScrollV;
                  }
                  this.var_1022 = false;
               }
            }
            else if(param2.name == const_1187)
            {
               if(this.var_20)
               {
                  this.var_1022 = true;
            ...
            else if(param2.name == const_846)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_551).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
                     this.scrollH -= (this.var_20.visibleRegion.width - this.var_20.scrollStepH) / this.var_20.maxScrollH;
                  }
               ...
               {
                  this.scrollV -= (this.var_20.visibleRegion.height - this.var_20.scrollStepV) / this.var_20.maxScrollV;
               }
         ...
         if(param1.type == WindowMouseEvent.const_286)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_829) as IScrollableWindow;
            if(_loc1_ == null && var_13 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_13).findChildByName(this.var_829) as IScrollableWindow;
               if(_loc1_)
               {
