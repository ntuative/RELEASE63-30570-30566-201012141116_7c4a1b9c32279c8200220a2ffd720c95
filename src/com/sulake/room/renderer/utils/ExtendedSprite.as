package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1203:int = 128;
      
      private var var_1204:Boolean = false;
      
      private var var_2625:Point;
      ...
      {
         if(param1 != this.var_1479 || param2 != this.var_1478)
         {
      ...
      {
         if(this.var_1203 > 255 || bitmapData == null)
         {
            return false;
         }
