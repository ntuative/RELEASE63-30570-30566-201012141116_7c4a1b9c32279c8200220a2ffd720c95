package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_298:IRoomObjectController;
      ...
      {
         if(this.var_298 == param1)
         {
            return;
         }
         if(this.var_298 != null)
         {
            this.var_298.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_298 = param1;
            this.var_298.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_298 != null)
            {
               this.var_298.setLocation(param1.loc);
               this.var_298.setDirection(param1.dir);
            }
         }
      }
   }
