package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1259:int = 0;
      
      public static const const_1255:int = 1;
      
      public static const const_1102:int = 2;
      ...
      private var var_133:IRoomManagerListener;
      
      private var var_2664:IRoomContentLoader;
      
      private var var_513:IRoomObjectFactory = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_532,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_706,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_513 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_513 == null || this.var_415 == null)
         {
            return;
         }
         this._state = const_1255;
         if(this.var_934 != null)
         {
            _loc1_ = this.var_934;
            this.var_934 = null;
            this.initialize(_loc1_,this.var_133);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_515.indexOf(_loc5_) < 0)
            {
               this.var_44.loadObjectContent(_loc5_,events);
               this.var_515.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1102;
         return true;
      }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_514.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_514[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_415.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_415.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_513.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_513 != null)
         {
            return this.var_513.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_798)
         {
            return;
         }
         if(this.var_44 == null)
         {
            this._state = const_798;
            return;
         }
         if(this.var_44.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_515.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_515.splice(_loc2_,1);
            }
            if(this.var_515.length == 0)
            {
               ...
               {
                  this.var_133.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_798;
            this.var_133.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_133 != null)
            {
               this.var_133.contentLoaded(null,false);
            }
            return;
         }
         ...
         if(_loc3_ == null)
         {
            if(this.var_133 != null)
            {
               this.var_133.contentLoaded(_loc2_,false);
            }
            return;
         }
         ...
         if(this.var_133 != null)
         {
            this.var_133.contentLoaded(_loc2_,true);
         }
         if(this.var_515.length > 0)
         {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_44 == null || this.var_415 == null)
         {
            return;
         }
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_415.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_415.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_513.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(this.var_133 != null)
                                 {
                                    this.var_133.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
