package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_648:Number = 64;
      
      public static const const_974:Number = 32;
      ...
      private var var_155:Vector3d;
      
      private var var_1126:Vector3d;
      
      private var _scale:Number = 1.0;
      
      private var var_396:Number = 1.0;
      
      private var var_395:Number = 1.0;
      
      private var var_394:Number = 1.0;
      
      private var var_1783:Number = 1.0;
      
      private var var_1781:Number = 1.0;
      
      private var var_1782:Number = 1.0;
      ...
      private var var_2649:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1126 = new Vector3d();
         this.var_1783 = 1;
         this.var_1781 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1782 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_155.x,this.var_155.y,this.var_155.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_76.x * this.var_396,this.var_76.y * this.var_395,this.var_76.z * this.var_394);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_244.x,this.var_244.y,this.var_244.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_396 != param1 * this.var_1783)
         {
            this.var_396 = param1 * this.var_1783;
            ++this.var_148;
         }
      }
      ...
      {
         if(this.var_395 != param1 * this.var_1781)
         {
            this.var_395 = param1 * this.var_1781;
            ++this.var_148;
         }
      }
      ...
      {
         if(this.var_394 != param1 * this.var_1782)
         {
            this.var_394 = param1 * this.var_1782;
            ++this.var_148;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_76.x /= this.var_396;
         this.var_76.y /= this.var_395;
         this.var_76.z /= this.var_394;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_244.x;
         var _loc3_:Number = this.var_244.y;
         var _loc4_:Number = this.var_244.z;
         this.var_244.assign(param1);
         if(this.var_244.x != _loc2_ || this.var_244.y != _loc3_ || this.var_244.z != _loc4_)
         {
            ++this.var_148;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_154.assign(_loc24_);
            this.var_155.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_154.assign(_loc19_);
            this.var_155.assign(_loc20_);
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_486 != null)
         {
            ...
            this.var_486.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_486.add(_loc3_,_loc4_);
            ++this.var_148;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_486 != null)
         {
            ...
            return this.var_486.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1126.assign(_loc22_);
         }
         else
         {
            this.var_1126.assign(_loc17_);
         }
         ++this.var_148;
      }
      ...
      {
         if(param1 == null || this.var_155 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_155,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_154);
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_155);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_396;
         _loc2_.y *= this.var_395;
         _loc2_.z *= this.var_394;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1126);
         if(_loc3_ < this.var_2648 || _loc3_ > this.var_2649)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_154);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_395;
            _loc2_.z *= this.var_394;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1126);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_154,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_76.x * this.var_396,this.var_76.y * this.var_395,this.var_76.z * this.var_394);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_155;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_396,param2.y * this.var_395,param2.z * this.var_394);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_396,param3.y * this.var_395,param3.z * this.var_394);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_396,param4.y * this.var_395,param4.z * this.var_394);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_974;
         }
         else
         {
            this.scale = const_648;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_648;
      }
