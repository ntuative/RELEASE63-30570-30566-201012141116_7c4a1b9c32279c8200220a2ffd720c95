package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1732 = param1.invDigit();
         this.var_1731 = this.var_1732 & 32767;
         this.var_2429 = this.var_1732 >> 15;
         this.var_2430 = 131071;
         this.var_2428 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_151) > 0)
         {
